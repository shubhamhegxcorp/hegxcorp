        ...
        <section className="border-y border-[#EAEAEA] bg-[#FAFAF8] px-6 py-24 lg:px-10">
            ...
            <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
                ...
                >
                    ...
                    <p className="mt-6 max-w-xl text-base leading-8 text-[#5F6B7A]">
                        {description}
                    </p>
                    ...
                    {focusOptions.length > 0 && (
                        <div className="mt-9 grid gap-3">
                            {focusOptions.map((option) => (
                                <div key={option} className="flex items-start gap-3 border border-[#E5E7EB] bg-white p-4">
                    ...
                    {isSubmitted ? (
                        <div className="grid min-h-[420px] place-items-center text-center">
                            <div>
                                ...
                                <h4 className="text-2xl font-black text-[#06133D]">
                                    Message received
                                </h4>
                                <p className="mx-auto mt-3 max-w-sm text-sm leading-7 text-[#5F6B7A]">
                                    Your {serviceName.toLowerCase()} inquiry is logged. Hegxcorp will review it and respond with next steps.
                                </p>
                                <button
                                    type="button"
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                            <div className="grid gap-4 sm:grid-cols-2">
                                <div>
                                    <label htmlFor={`${serviceId}-name`} className="mb-2 block text-xs font-black uppercase tracking-[0.12em] text-[#6B7280]">
                                        Full name
                                    </label>
                                    <input
                                        id={`${serviceId}-name`}
                                ...
                                <div>
                                    <label htmlFor={`${serviceId}-phone`} className="mb-2 block text-xs font-black uppercase tracking-[0.12em] text-[#6B7280]">
                                        Phone
                                    </label>
                                    <input
                                        id={`${serviceId}-phone`}
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                                <div>
                                    <label htmlFor={`${serviceId}-email`} className="mb-2 block text-xs font-black uppercase tracking-[0.12em] text-[#6B7280]">
                                        Business email
                                    </label>
                                    <input
                                        id={`${serviceId}-email`}
                                ...
                                <div>
                                    <label htmlFor={`${serviceId}-website`} className="mb-2 block text-xs font-black uppercase tracking-[0.12em] text-[#6B7280]">
                                        Website
                                    </label>
                                    <input
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                                <div>
                                    <label htmlFor={`${serviceId}-budget`} className="mb-2 block text-xs font-black uppercase tracking-[0.12em] text-[#6B7280]">
                                        Monthly budget
                                    </label>
                                    <select
                                        id={`${serviceId}-budget`}
                                ...
                                <div>
                                    <label htmlFor={`${serviceId}-timeline`} className="mb-2 block text-xs font-black uppercase tracking-[0.12em] text-[#6B7280]">
                                        Timeline
                                    </label>
                                    <select
                            ...
                            <div>
                                <label htmlFor={`${serviceId}-message`} className="mb-2 block text-xs font-black uppercase tracking-[0.12em] text-[#6B7280]">
