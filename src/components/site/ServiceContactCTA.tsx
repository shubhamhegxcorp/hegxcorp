                ...
                >
                    ...
                    <div className="mt-8 grid gap-3 sm:grid-cols-3">
                        {contactPromises.map((promise) => (
                            <div key={promise} className="flex items-start gap-3 rounded-2xl border border-white/10 bg-white/[0.06] p-4">
                        ...
                        <div className="mt-6 rounded-2xl border border-white/10 bg-white/[0.05] p-4">
                            ...
                            <div className="grid gap-3">
                                {nextSteps.map(([step, label, copy]) => (
                                    <div key={step} className="grid grid-cols-[40px_1fr] gap-3 rounded-xl border border-white/10 bg-white/[0.04] p-3">
