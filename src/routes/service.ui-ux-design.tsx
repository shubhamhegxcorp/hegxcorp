    ...
    <section className="relative overflow-hidden bg-[#050B24] px-6 py-24 text-white lg:px-10 lg:pt-28 lg:pb:14">
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-14 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        >
          ...
          >
            Hegxcorp designs websites, SaaS interfaces, mobile app flows, landing pages, and design
            systems that feel premium, guide users clearly, and support measurable business growth.
          </p>
            ...
            <div className="rounded-[22px] border border-white/10 bg-[#071333]/92 p-6">
              <div className="mb-7 flex items-center justify-between gap-5">
                <div>
                  ...
                  <h2 className="mt-2 text-2xl font-black text-white">UI/UX Design System</h2>
                </div>
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-12 max-w-3xl">
          ...
          <p className="mt-5 max-w-2xl text-base leading-8 text-[#5F6B7A]">
            Every design layer is planned to reduce confusion, make value easier to understand, and
            support a stronger conversion path across desktop and mobile.
          </p>
        </div>
        ...
        <div className="seo-split-reveal">
          <div className="seo-split-left">
            ...
            <p className="seo-split-body">
              We combine research, structure, interface design, conversion thinking, and system
              documentation into one practical design workflow.
            </p>
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-14 grid gap-9 lg:grid-cols-[1.08fr_0.92fr] lg:items-end lg:gap-12">
          ...
          <p className="max-w-2xl text-base leading-8 text-[#5F6B7A]">
            Strong UI/UX design is not only a screen mockup. It is a working system of page logic,
            user psychology, visual hierarchy, responsive behavior, and handoff detail that helps
      ...
      <div className="relative mx-auto grid max-w-6xl gap-14 lg:grid-cols-[0.76fr_1fr] lg:items-start lg:gap-24">
        <div>
          ...
          <p className="mt-6 max-w-xl text-base leading-8 text-white/70">
            We keep deliverables practical. The goal is not a pretty file that sits unused. The goal
            is a clear experience system that helps marketing, design, and development ship better
            pages faster.
          </p>
        </div>
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mx-auto mb-14 max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-[#5F6B7A]">
            Whether you are rebuilding a service website, improving a product flow, or launching a
            campaign page, the design should make your value easier to understand and easier to
            choose.
          </p>
        </div>
