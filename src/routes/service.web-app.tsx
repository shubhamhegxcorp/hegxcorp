...
const appTypes = [
    ["Business Dashboards", "Track users, enquiries, orders, reports, team activity, and key business data."],
    ["Customer Portals", "Give customers a secure place to manage requests, submit forms, and track updates."],
    ["Internal Tools", "Replace spreadsheets and manual processes with systems built around real operations."],
    ["Automation Systems", "Automate approvals, notifications, data movement, and repetitive admin tasks."],
];
...
const process = [
    ["Discovery", "Understand your business process, users, required features, workflows, data needs, and goals."],
    ["Planning", "Plan the structure, roles, database, screens, backend logic, integrations, and roadmap."],
    ["UI Design", "Design practical application screens that make complex workflows simple for users."],
    ["Development", "Build frontend screens, backend systems, APIs, databases, authentication, and core features."],
    ["Testing & Launch", "Test features, responsiveness, security, forms, APIs, user flows, and deploy the app."],
];
                    ...
                    <div className="relative mx-auto grid max-w-6xl items-center gap-14 lg:grid-cols-[0.95fr_1.05fr]">
                        <div>
                            ...
                            <p className="mt-7 max-w-2xl text-base leading-8 text-white/74 md:text-lg">
                                Build a secure, scalable, and high-performance web application
                                that simplifies business operations, improves user experience,
                    ...
                    <div className="mx-auto grid max-w-6xl gap-8 md:grid-cols-4">
                        {metrics.map((item) => (
                            <div key={item.label} className="text-center md:text-left">
                                <strong className="text-4xl font-black text-[#FC9C44]">
                                    {item.value}
                                </strong>
                    ...
                    <div className="mx-auto grid max-w-6xl gap-14 lg:grid-cols-[0.8fr_1.2fr]">
                        <div>
                            ...
                            <p className="mt-6 text-base leading-8 text-slate-500">
                                Instead of forcing your team into ready-made software, we build
                                browser-based systems that match your exact workflow, data
                                structure, approval process, reporting needs, user roles, and
                                daily operations.
                            </p>
                            <p className="mt-5 text-base leading-8 text-slate-500">
                                Every module is planned to reduce manual work, improve
                                visibility, and give your team a cleaner way to manage tasks,
                                customers, requests, and business information from one secure
                                application.
                            </p>
                            <p className="mt-5 text-base leading-8 text-slate-500">
                                Whether you need a dashboard, customer portal, SaaS platform,
                                booking system, CRM workflow, or internal management tool, the
                                application is shaped around how your business actually runs.
                            </p>
                        </div>
                        ...
                        <div>
                            {services.map((service, index) => {
                                ...
                                return (
                                    <div
                                        key={service.title}
                                        className={`grid gap-5 py-7 md:grid-cols-[56px_1fr] ${isLast ? "" : "border-b border-slate-200"
                                            }`}
                                    >
                        ...
                        <div className="grid gap-10 md:grid-cols-2">
                            {appTypes.map(([title, text], index) => (
                                <div key={title} className="flex gap-6 border-t border-slate-300 pt-7">
                                    <span className="text-5xl font-black text-[#FC9C44]/40">
                                        0{index + 1}
                                    </span>
                                    <div>
                    ...
                    <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
                        <div>
                            ...
                            <p className="mt-6 text-base leading-8 text-white/70">
                                We create web applications that are easy to use, secure,
                                scalable, fast, and structured around the way your team and
                ...
                <section className="bg-white px-6 py-24 lg:px-10">
                    <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.75fr_1.25fr]">
                        <div>
                            ...
                            <p className="mt-6 text-base leading-8 text-slate-500">
                                Good web applications need more than attractive screens. We plan
                                the interface, logic, database, security, integrations, and
                ...
                <section className="bg-white px-6 py-24 lg:px-10">
                    <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
                        <div>
                            ...
                            <p className="mt-6 text-base leading-8 text-slate-500">
                                We help businesses move important workflows into reliable digital
                                systems that are easier to manage, measure, and improve.
                            </p>
                        </div>
                    ...
                    <div className="mx-auto max-w-6xl">
                        ...
                        <div className="overflow-hidden border-y border-slate-300">
                            {process.map(([title, text], index) => (
                                ...
                                >
                                    <span className="text-3xl font-black text-[#FC9C44]">
                                        0{index + 1}
                                    </span>
