      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-14 max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-[#5F6B7A]">
            Hegxcorp plans content as a connected system. One strong idea can become a ranking page,
            a blog, a social post, an email, a sales asset, and a campaign message when the strategy
            is clear.
          </p>
        </div>
        ...
        <div className="mb-14 grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-end lg:gap-14">
          ...
          <div className="w-full border border-white/12 bg-white/[0.06] p-6 shadow-[0_24px_70px_-54px_rgba(0,0,0,0.75)]">
            <p className="text-base leading-8 text-white/72">
              Good content is not just writing. It is research, structure, positioning, search
              intent, proof, publishing rhythm, repurposing, and continuous improvement working
              together so every piece has a clear job in the customer journey.
            </p>
      ...
      <div className="relative mx-auto max-w-6xl">
        <div className="mx-auto mb-14 max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-base leading-7 text-[#4F5B76]">
            Click a step to move through the content. Each step opens with a smooth top-down
            transition.
          </p>
        </div>
          ...
          <div className="lg:sticky lg:top-28">
            <div className="rounded-[28px] border border-[#DFE3EA] bg-white p-5 shadow-[0_26px_70px_-44px_rgba(29,39,66,0.45)]">
              <div className="rounded-[22px] bg-[#06133D] p-6 text-white">
                ...
                <h3 className="mt-3 text-3xl font-black leading-tight">{activeItem.title}</h3>
                <p className="mt-4 text-sm leading-7 text-white/64">{activeItem.copy}</p>
        ...
        <section className="relative overflow-hidden bg-[#050B24] px-6 py-24 text-white lg:px-10 lg:pt-28 lg:pb-14">
          ...
          <div className="relative mx-auto grid max-w-6xl items-center gap-14 lg:grid-cols-[1fr_0.9fr]">
            ...
            >
              ...
              >
                Build trust, improve visibility, and turn ideas into strategic content that
                attracts, educates, and converts your ideal customers.
              </p>
            ...
            <div className="seo-split-reveal">
              <div className="seo-split-left">
                ...
                <p className="seo-split-body">
                  Hover or select a capability to see how each part of the content system answers
                  questions, strengthens brand voice, and moves buyers closer to choosing you.
                </p>
