...
const ppcChannelServices = [
    {
        ...
        title: "Google Search Ads",
        copy:
            "High-intent search campaigns built around keyword groups, ad relevance, landing page intent, negatives, bid control, and conversion tracking.",
    ...
    },
    {
        ...
        copy:
            "PMax structure for ecommerce and lead generation with audience signals, asset groups, feed hygiene, exclusions, search themes, and value-based goals.",
    ...
    },
    {
        ...
        title: "Meta & Instagram Ads",
        copy:
            "Creative-led paid social campaigns with hooks, formats, audience tests, retargeting pools, offer angles, and conversion objective alignment.",
    ...
    },
    {
        ...
        copy:
            "Account-based and role-based campaigns for B2B brands that need decision-maker reach, lead magnets, remarketing, and pipeline quality.",
    ...
    },
    {
        ...
        copy:
            "Product feed optimization, shopping campaigns, category budget control, dynamic remarketing, conversion value tracking, and ROAS reporting.",
    ...
    },
    {
        ...
        copy:
            "Awareness and retargeting campaigns that reconnect with visitors, video viewers, cart abandoners, and engaged audiences across the funnel.",
                ...
                <div className="mb-14 grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-end lg:gap-14">
                    ...
                    <div className="border border-[#E5E7EB] bg-[#FAFAF8] p-6 shadow-[0_22px_70px_-54px_rgba(6,19,61,0.5)]">
                        <p className="text-base leading-8 text-[#5F6B7A]">
                            Hegxcorp builds PPC systems across search, social, shopping, video, display, and retargeting so every channel has the right message, tracking, landing page, budget rule, and optimization rhythm before scale.
                        </p>
                        <div className="mt-6 grid gap-3 sm:grid-cols-2">
                            {["Search intent", "Paid social", "Shopping ads", "Retargeting"].map((item) => (
                                <span key={item} className="border border-[#E5E7EB] bg-white px-4 py-3 text-sm font-black text-[#06133D]">
                                    {item}
                                </span>
                            ))}
                        </div>
...
const ppcWhyCards = [
    {
        ...
        copy:
            "Search terms, placements, negatives, audience quality, and conversion signals are checked early so budget does not disappear into poor-fit traffic.",
    },
    {
        icon: Gauge,
        title: "Tracking before scaling",
        copy:
            "We confirm events, values, forms, calls, ecommerce actions, and analytics flows before recommending heavier budget allocation.",
    },
    {
        icon: Layers,
        title: "Landing page alignment",
        copy:
            "Campaigns are reviewed with page speed, offer clarity, message match, trust elements, and conversion friction in mind.",
    },
    {
        icon: BarChart3,
        title: "Reporting that explains action",
        copy:
            "Reports show what changed, what improved, where budget moved, which tests mattered, and what should happen next.",
    },
];
                ...
                <div className="mb-14 grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-end lg:gap-14">
                    ...
                    <div className="w-full max-w-3xl justify-self-end">
                        <p className="text-base leading-8 text-white/72">
                            PPC can create demand quickly, but it can also waste budget quickly. Hegxcorp focuses on clean setup, useful data, landing page alignment, and measured scaling so paid media has a stronger chance of becoming profitable without losing control of spend, tracking quality, or lead value.
                        </p>

                        <div className="mt-6 grid gap-3 sm:grid-cols-3">
                            {["Budget discipline", "Tracking clarity", "Landing page fit"].map((item) => (
                                <div key={item} className="border border-white/12 bg-white/[0.06] px-4 py-3 text-sm font-bold text-white/82">
                                    {item}
                                </div>
                            ))}
                        </div>
        ...
        <section className="relative overflow-hidden bg-[#050B24] px-6 py-24 text-white lg:px-10 lg:pt-28 lg:pb-14">
            ...
            <div className="relative mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[1fr_0.9fr]">
                ...
                >
                    ...
                    >
                        Launch, optimize, and scale PPC campaigns across Google, Meta, LinkedIn, and retargeting channels with clear tracking and revenue-focused decisions.
                    </p>
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                                {[
                                    ...
                                    <div key={label} className="rounded-2xl border border-white/10 bg-white/[0.06] p-4">
                                        ...
                                        <p className={`mt-3 text-3xl font-black ${index === 0 ? "text-[#FC9C44]" : "text-white"}`}>
                                            {value}
                                        </p>
                                    </div>
                                ))}
                ...
                <div className="seo-split-reveal">
                    <div className="seo-split-left">
                        ...
                        <h2 className="seo-split-heading">
                            Paid media systems for profitable acquisition
                        </h2>
                        <p className="seo-split-body">
                            Hover or select a capability to see how each part of the PPC system improves targeting, conversion quality, spend control, and ROAS.
                        </p>
            ...
            <div className="mx-auto max-w-6xl">
                <div className="relative mx-auto mb-12 max-w-4xl text-center">
                    ...
                    <p className="mx-auto mt-4 max-w-3xl text-base leading-7 text-[#4F5B76]">
                        Each part of the paid growth system is built to protect budget, improve conversion quality, and scale only when performance is clear.
                    </p>
                </div>
