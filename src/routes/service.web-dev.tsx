                ...
                <section className="bg-white px-6 py-24 lg:px-10">
                    <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.85fr_1.15fr]">
                        ...
                        <div className="space-y-6 text-base leading-8 text-slate-600">
                            <p>
                                A strong website helps visitors understand your business, trust your expertise, compare your services, and take the next step. It supports SEO, paid ads, social media, email campaigns, sales conversations, and everyday brand credibility.
                            </p>

                            <p>
                                We combine UI/UX design, content structure, clean development, speed, responsive behaviour, integrations, and ongoing support so your website becomes a practical growth asset, not just a digital brochure.
                            </p>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="mx-auto grid max-w-6xl gap-14 lg:grid-cols-[0.8fr_1.2fr]">
                        <div className="lg:sticky lg:top-28 lg:self-start">
                            ...
                            <p className="mt-6 text-base leading-8 text-slate-500">
                                From first impression to final enquiry, every website section is planned to improve clarity, speed, trust, and conversion.
                            </p>
                            ...
                            <p className="mt-6 text-base leading-8 text-slate-500">
                                The goal is to make your website easier to understand, easier to manage, and easier to scale as your business grows.
                            </p>
                        </div>
                    ...
                    <div className="mx-auto max-w-6xl">
                        <div className="mb-14 text-center">
                            ...
                            <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-slate-500">
                                We turn your website requirement into a structured digital product through planning, design, development, testing, launch, and long-term improvement.
                            </p>
                        </div>
                                ...
                                {developmentServices.map((item, index) => {
                                    ...
                                    return (
                                        <div key={item.title} className="border-b border-slate-200 last:border-b-0">
                                            ...
                                            >
                                                <span className="text-lg font-bold text-[#06133D]">
                                                    {item.title}
                                                </span>

                                                <ChevronRight
                                                    className={`h-5 w-5 shrink-0 text-[#FC9C44] transition ${isOpen ? "rotate-90" : "group-hover:translate-x-1"
                                                        }`}
                                                />
                                            </button>
                    ...
                    <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
                        <div>
                            ...
                            <p className="mt-6 text-base leading-10 text-slate-500">
                                Every important section is planned to make your offer easier to understand.
                                The content helps visitors see your value, services, and trust signals clearly.
                                Each page then guides them toward the next action with confidence.
                            </p>
                        </div>
                ...
                <section className="bg-white px-6 py-24 lg:px-10">
                    <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
                        <div>
                            ...
                            <p className="mt-6 text-base leading-8 text-slate-500">
                                We help different industries turn services, campaigns, products, and enquiries into a stronger online experience.
                            </p>
                        </div>
                        ...
                        <div className="grid gap-8 p-8 md:p-12 lg:grid-cols-[1fr_0.7fr] lg:items-center">
                            <div>
                                ...
                                <p className="mt-5 max-w-2xl text-base leading-8 text-white/65">
                                    Let us plan a website that explains your services clearly, improves trust, supports campaigns, and gives visitors a smooth path to enquiry.
                                </p>
                            </div>
                            ...
                            <div className="border-l border-white/15 pl-8">
                                ...
                                <p className="mt-3 text-sm leading-7 text-white/65">
                                    Get planning, UI, frontend, backend, integrations, testing, launch, and maintenance in one place.
                                </p>
