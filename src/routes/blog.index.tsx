            ...
            <div className="mx-auto w-full max-w-[560px] lg:mx-0 lg:justify-self-end">
              <Link to="/blog/$slug" params={{ slug: featuredArticle.slug }} className="block">
                <motion.article className="overflow-hidden rounded-xl border border-[#EAEAEA] bg-white text-left shadow-[0_16px_36px_rgba(29,39,66,0.06)] transition-shadow duration-300 hover:shadow-[0_24px_48px_rgba(29,39,66,0.1)]">
                  ...
                  <div className="group/text space-y-4 border-t border-[#EAEAEA] p-6">
                    <div className="flex flex-wrap items-center gap-3 text-[10px] font-bold uppercase tracking-wider text-[#9CA3AF]">
                      <span className="text-[#FC9C44]">Featured Article</span>
                    ...
                    <div className="flex items-center gap-2 text-sm font-bold text-[#1D2742] transition-colors duration-200 group-hover/text:text-[#FC9C44]">
                      <span>Read Article</span>
                      <ArrowRight className="h-4 w-4 transition-transform duration-200 group-hover/text:translate-x-1" />
                    </div>
                  </div>
                </motion.article>
              </Link>
                      ...
                      {paginatedArticles.map((article) => (
                        ...
                        >
                          ...
                          >
                            ...
                            <div className="aspect-video overflow-hidden border-b border-[#EAEAEA] bg-[#FAFAF8]">
                              <img
        ...
        <div className="relative mx-auto max-w-[1200px] overflow-hidden rounded-[2rem] bg-[#06133D] px-6 py-14 text-center text-white sm:px-12 sm:py-16">
          ...
          <div className="relative mx-auto max-w-3xl">
            <p className="text-sm font-bold uppercase tracking-[0.2em] text-[#FFB36E]">
              Keep Learning With Hegxcorp
            </p>
            <h2 className="mt-4 text-3xl font-bold leading-tight sm:text-4xl lg:text-5xl">
              Want sharper ideas for your next stage of growth?
            </h2>
            <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-white/70">
              Read more practical insights from our team, or talk with us about turning what you
              learn into a focused digital plan.
            </p>
