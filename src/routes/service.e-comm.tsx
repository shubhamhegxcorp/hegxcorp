                    ...
                    <div className="relative mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1fr_0.95fr] lg:items-center">
                        <div>
                            ...
                            <p className="mt-7 max-w-2xl text-lg leading-8 text-white/74">
                                Build a fast, secure, and conversion-focused online store that
                                helps your business sell products, manage orders, and grow
                                revenue online.
                            </p>
                    ...
                    <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
                        <div className="lg:sticky lg:top-28">
                            ...
                            <p className="mt-6 text-base leading-8 text-slate-500">
                                We create ecommerce websites that make it easy for customers to
                                find products, understand value, complete checkout, and return
                    ...
                    <div className="mx-auto max-w-6xl">
                        <div className="mb-14 max-w-3xl">
                            ...
                            <p className="mt-6 text-base leading-8 text-white/70">
                                We follow a clear ecommerce development process so your store is
                                planned properly, tested carefully, and ready for real customer
                                orders.
                            </p>
                        </div>
                ...
                <section className="bg-[#F8FAFC] px-6 py-24 lg:px-10">
                    <div className="mx-auto grid max-w-6xl gap-6 md:grid-cols-3">
                        <div className="rounded-[28px] bg-white p-8 shadow-sm ring-1 ring-slate-200">
                            ...
                            <p className="mt-4 text-sm leading-7 text-slate-500">
                                Store pages are structured to support trust, product clarity,
                                smooth checkout, and better sales.
                            </p>
                        </div>
                        ...
                        <div className="rounded-[28px] bg-white p-8 shadow-sm ring-1 ring-slate-200">
                            ...
                            <p className="mt-4 text-sm leading-7 text-slate-500">
                                Configure delivery options, shipping rules, order statuses,
                                customer emails, and fulfilment workflows.
                            </p>
                        </div>
                        ...
                        <div className="rounded-[28px] bg-white p-8 shadow-sm ring-1 ring-slate-200">
                            ...
                            <p className="mt-4 text-sm leading-7 text-slate-500">
                                Build customer trust with secure payment flow, reliable forms,
                                stable integrations, and protected transactions.
                            </p>
                        </div>
                    </div>
                </section>
