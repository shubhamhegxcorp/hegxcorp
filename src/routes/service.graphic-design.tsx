      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-14 max-w-4xl">
          ...
          <p className="mt-6 max-w-3xl text-base leading-8 text-[#5F6B7A]">
            Hegxcorp builds graphic design as a usable creative system, not just single files. Your
            social posts, ads, brochures, decks, templates, campaign visuals, and digital graphics
            should all carry the same level of clarity and brand confidence.
          </p>
        </div>
      ...
      <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
        <div>
          ...
          <p className="mt-6 text-base leading-8 text-white/72">
            A good creative system helps your team publish faster, run better campaigns, and keep
            visual quality consistent across every sales and marketing touchpoint.
          </p>
        </div>
                ...
                <div className="rounded-[22px] border border-white/10 bg-[#071333]/92 p-6">
                  <div className="mb-7 flex items-center justify-between">
                    <div>
                      ...
                      <h2 className="mt-2 text-2xl font-black text-white">Visual Asset System</h2>
                    </div>
            ...
            <div className="seo-split-reveal">
              <div className="seo-split-left">
                ...
                <p className="seo-split-body">
                  Hover or select a capability to see how each design layer helps your brand show up
                  clearly across social, ads, presentations, print, and campaigns.
                </p>
