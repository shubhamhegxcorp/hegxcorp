      ...
      <div className="relative mx-auto grid w-full max-w-6xl min-w-0 items-center gap-14 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        >
          ...
          <p className="mt-7 max-w-2xl text-lg leading-8 text-white/74">
            Build a premium, consistent, and memorable brand identity that helps customers
            understand your value, trust your business, and recognize you across every touchpoint.
          </p>
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-12 grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
          ...
          <p className="text-base leading-8 text-[#5F6B7A]">
            Hover or select a branding layer to see how strategy, visuals, voice, and guidelines
            work together. The goal is not just a better logo. It is a brand your team can use with
            confidence.
          </p>
        </div>
                  ...
                  <span className="flex items-start gap-4">
                    <span
                      className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-xl transition ${
                        isActive ? "bg-[#FC9C44] text-white" : "bg-[#06133D] text-white"
                      }`}
                    >
                ...
                <div>
                  <div className="mb-8 overflow-hidden border border-white/10 bg-white/5">
                    <div className="relative h-145 overflow-hidden">
                      ...
                      />
                      <div className="absolute inset-0" style={{ background: active.visual }} />
      ...
      <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        ...
        >
          ...
          <p className="mt-6 text-base leading-8 text-[#5F6B7A]">
            Strong branding turns scattered design into a repeatable identity. These are the layers
            Hegxcorp can plan, design, refine, and hand over as one usable brand system.
          </p>
          ...
          <div className="mt-9 grid gap-3">
            {[
              [
                "Strategy-led",
                "Every identity choice is tied to market position, audience trust, and business goals.",
              ],
              ...
              <div
                key={label}
                className="border border-[#E5E7EB] bg-white p-5 shadow-[0_18px_45px_-38px_rgba(6,19,61,0.45)]"
              >
                <p className="text-xs font-black uppercase tracking-[0.16em] text-[#FC9C44]">
                  {label}
                </p>
                <p className="mt-2 text-sm font-semibold leading-6 text-[#516070]">{copy}</p>
              </div>
            ))}
          </div>
        </motion.div>
      ...
      <div className="relative mx-auto max-w-6xl">
        <div className="mb-12 max-w-3xl">
          ...
          <p className="mt-6 text-base leading-8 text-white/68">
            We move from insight to execution with enough structure for quality and enough
            flexibility for creative direction. Each stage gives the next stage better inputs.
          </p>
        </div>
    ...
    <section className="bg-white px-6 py-24 lg:px-10">
      <div className="mx-auto max-w-6xl">
        <div className="mb-12 grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-end">
          ...
          <p className="text-base leading-8 text-[#5F6B7A]">
            The output is designed for real business use. Your team gets clear creative direction,
            organized files, and templates that make the new identity easier to apply every day.
          </p>
        </div>
    ...
    <section className="overflow-hidden bg-[#FAFAF8] px-6 py-24 lg:px-10">
      <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        ...
        >
          ...
          <p className="mt-6 text-base leading-8 text-[#5F6B7A]">
            A premium brand should not depend on one designer remembering every detail. We define
            repeatable rules for messaging, visuals, templates, and rollout so every new asset feels
            connected.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
