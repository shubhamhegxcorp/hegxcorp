          ...
          <div className="relative mx-auto grid max-w-6xl items-center gap-14 lg:grid-cols-[0.95fr_1.05fr]">
            <div>
              ...
              <p className="mt-7 max-w-2xl text-lg leading-8 text-white/74">
                Build a fast, secure, responsive, and easy-to-manage WordPress website that helps
                your business look professional, generate enquiries, and grow online.
              </p>
              ...
              <div className="rounded-[24px] bg-[#06133D] p-6 text-white">
                <div className="mb-7 flex items-center justify-between">
                  <div>
                    ...
                    <h2 className="mt-2 text-2xl font-black">Modern CMS Build</h2>
                  </div>

                  <div className="flex h-12 w-12 items-center justify-center rounded-g-[#FC9C44]">
                    xl b
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {["Editable Pages", "Theme Setup", "WooCommerce", "Secure Admin"].map((item) => (
        ...
        <section className="bg-white px-6 py-14 lg:px-10">
          <div className="mx-auto grid max-w-6xl gap-5 md:grid-cols-2 lg:grid-cols-4">
            {metrics.map((item) => (
              <div
                key={item.label}
                className="rounded-[26px] bg-[#F8FAFC] p-7 ring-1 ring-slate-200"
              >
          ...
          <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              ...
              <p className="mt-6 text-base leading-8 text-white/70">
                We create WordPress websites that are easy to manage, secure, responsive, fast, and
                structured around your services, content, products, and marketing goals.
              </p>
          ...
          <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              ...
              <p className="mt-6 text-base leading-8 text-slate-500">
                A good WordPress website needs more than a theme. We plan the content structure, CMS
                setup, plugins, security, speed, forms, SEO basics, and future updates together.
              </p>
            </div>
            ...
            <div className="grid gap-5">
              {architecture.map((item, index) => (
                <div
                  key={item.title}
                  className="flex gap-5 rounded-[24px] border border-slate-200 bg-[#F8FAFC] p-6"
                >
        ...
        <section className="bg-white px-6 py-24 lg:px-10">
          <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              ...
              <p className="mt-6 text-base leading-8 text-slate-500">
                We help businesses move their brand, content, services, products, campaigns, and
                enquiries into a reliable WordPress system that is easier to manage and improve.
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {useCases.map((item) => (
                <div
                  key={item}
                  className="flex items-center gap-3 rounded-2xl bg-[#F8FAFC] p-5 font-bold ring-1 ring-slate-200"
                >
        ...
        <section className="bg-[#F8FAFC] px-6 py-24 lg:px-10">
          <div className="mx-auto max-w-6xl">
            <div className="mb-14 max-w-3xl">
              ...
              <p className="mt-6 text-base leading-8 text-slate-500">
                We follow a clear process so your WordPress website is planned properly, built
                cleanly, tested carefully, and launched with confidence.
              </p>
            </div>
        ...
        <section className="bg-white px-6 py-24 lg:px-10">
          <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1fr_1fr] lg:items-center">
            <div className="rounded-[32px] bg-[#06133D] p-8 text-white md:p-10">
              ...
              <p className="mt-6 text-base leading-8 text-white/70">
                Whether your team handles blogs, service pages, landing pages, products, media,
                campaigns, or forms, we can structure WordPress so updates feel simple and
                organised.
              </p>
            </div>
          ...
          <div className="mx-auto grid max-w-6xl gap-6 md:grid-cols-3">
            <div className="border-l-4 border-[#FC9C44] bg-white p-7 shadow-sm">
              ...
              <p className="mt-4 text-sm leading-7 text-slate-500">
                We configure secure admin access, trusted plugins, backups, updates, and basic
                hardening for a healthier website.
              </p>
            </div>
            ...
            <div className="border-l-4 border-[#FC9C44] bg-white p-7 shadow-sm">
              ...
              <p className="mt-4 text-sm leading-7 text-slate-500">
                We focus on caching, image optimisation, clean plugin usage, lighter pages, and
            ...
            <div className="border-l-4 border-[#FC9C44] bg-white p-7 shadow-sm">
              ...
              <p className="mt-4 text-sm leading-7 text-slate-500">
                Your WordPress website is designed to feel clear and usable across desktop, tablet,
                and mobile devices.
              </p>
            </div>
          </div>
            ...
            <div className="grid gap-8 p-8 md:p-12 lg:grid-cols-[1fr_0.7fr] lg:items-center">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-base leading-8 text-white/65">
                  Share your website idea, redesign requirement, WooCommerce plan, blog structure,
                  or content management need. We will help turn it into a clear WordPress
                  development roadmap.
                </p>
              </div>
              ...
              <div className="rounded-[24px] border border-white/10 bg-white/10 p-6">
                ...
                <p className="mt-3 text-sm leading-7 text-white/65">
                  Get planning, UI, WordPress setup, theme development, WooCommerce, plugins,
                  testing, launch, and maintenance in one place.
                </p>
