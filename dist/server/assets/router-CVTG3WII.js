...
import { createRootRouteWithContext, useRouter, Link, Outlet, HeadContent, Scripts, createFileRoute, lazyRouteComponent, useLocation, notFound, useParams, createRouter } from "@tanstack/react-router";
import { jsx, jsxs, Fragment } from "react/jsx-runtime";
import { useEffect, useState, useRef, useMemo, useCallback } from "react";
import Lenis from "lenis";
import { Globe, Phone, ChevronDown, Code2, Layers, LayoutTemplate, ShoppingCart, Search, MousePointerClick, Share2, PenLine, Palette, Sparkles, Image, ArrowRight, Check, TrendingUp, Menu, X, Linkedin, Twitter, Instagram, Facebook, ShieldCheck, BarChart3, User, Mail, Target, ArrowLeft, MapPin, Send, RefreshCw, UserRound, LockKeyhole, EyeOff, Eye, Inbox, ClipboardList, BookOpenText, LogOut, ChevronLeft, ChevronRight, CalendarClock, Award, Lightbulb, BadgeCheck, Handshake, Users, Zap, GitMerge, BarChart2, Quote, CalendarCheck, PhoneCall, FileText, Percent, BookOpen, Gauge, Layers3, Rocket, CheckCircle2, Settings, Cloud, Cross, GraduationCap, House, Briefcase, PenTool, CalendarDays, Clapperboard, Link2, Globe2, Building2, Youtube, Activity, Megaphone, LineChart, Smartphone, DollarSign, Presentation, Brush, Camera, MessageSquareText, MessageSquare, Clock, Calendar, Bookmark, Info, AlertCircle, ChevronsLeft, ChevronsRight, Star, XCircle, Archive } from "lucide-react";
...
import { c as createSsrRpc, i as inquiryStatuses, s as submitContactInquiry, l as listContactInquiries, u as updateContactInquiryStatus } from "./contact-inquiries-TJom85B0.js";
import { c as createServerFn } from "./server-BjMtisnP.js";
import gsap from "gsap";
import { ScrollTrigger } from "gsap/ScrollTrigger";
import { useGSAP } from "@gsap/react";
const appCss = "/assets/styles-bNBCcoN5.css";
...
const $$splitComponentImporter$8 = () => import("./terms-of-service-DkTqhZvE.js");
const Route$t = createFileRoute("/terms-of-service")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$7 = () => import("./services-Bj_MQoN-.js");
...
const $$splitComponentImporter$6 = () => import("./privacy-policy-CosUqAOJ.js");
const Route$q = createFileRoute("/privacy-policy")({
  head: () => ({
    meta: [{
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs(
            "aside",
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex h-16 items-center justify-between border-b border-border px-5", children: [
                  /* @__PURE__ */ jsx("img", { src: logoAsset, alt: "HEXGCORP", className: "h-8 w-auto" }),
                  /* @__PURE__ */ jsx(
                    "button",
                    {
...
const Route$p = createFileRoute("/industries")({
  head: () => ({
    meta: [
...
const Route$o = createFileRoute("/free-growth-audit")({
  head: () => ({
    meta: [
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white", children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "py-20 bg-white", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-[1280px] px-6 lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-[1fr_1.3fr] gap-16 items-center", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-[#EAEAEA] bg-[#FAFAF8] p-5 sm:p-8 lg:p-10 shadow-[0_20px_48px_-20px_rgba(29,39,66,0.08)]", children: [
        ...
        ] }) : /* @__PURE__ */ jsx("form", { onSubmit: handleSubmit(onSubmit), className: "space-y-6", children: /* @__PURE__ */ jsx(AnimatePresence, { mode: "wait", children: step === 1 ? (
...
const $$splitComponentImporter$5 = () => import("./cookie-policy-DKg5oKP6.js");
const Route$n = createFileRoute("/cookie-policy")({
  head: () => ({
    meta: [{
        ...
        /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "space-y-6 pt-8 border-t border-[#EAEAEA]", children: /* @__PURE__ */ jsx("div", { className: "relative pl-8 space-y-8", children: /* @__PURE__ */ jsx("div", { className: "absolute left-[15px] top-2 bottom-2 w-[1px] bg-[#EAEAEA]" }) }) })
            ]
          }
        ),
        /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "mb-6 flex items-start justify-between gap-4", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "rounded-full bg-[#FFF4E8] px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-[#FC9C44] opacity-0 transition-opacity duration-300 group-hover/form:opacity-100", children: "Fast reply" })
              ] }),
              isSubmitted ? /* @__PURE__ */ jsxs("div", { className: "text-center py-10 space-y-4", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-4", children: [
                  /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
                    ...
                    errors.name && /* @__PURE__ */ jsx("p", { className: "text-xs text-red-500 font-medium", style: { fontFamily: "'Inter', sans-serif" }, children: errors.name.message })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsx(
                      "label",
                    ...
                    errors.phone && /* @__PURE__ */ jsx("p", { className: "text-xs text-red-500 font-medium", style: { fontFamily: "'Inter', sans-serif" }, children: errors.phone.message })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsx(
                  ...
                  errors.email && /* @__PURE__ */ jsx("p", { className: "text-xs text-red-500 font-medium", style: { fontFamily: "'Inter', sans-serif" }, children: errors.email.message })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsx(
                    "label",
                  ...
                  /* @__PURE__ */ jsxs("div", { ref: serviceDropdownRef, className: "relative", children: [
                    /* @__PURE__ */ jsxs(
                      "button",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsx("span", { className: selectedServices.length ? "font-semibold text-[#232323]" : "text-[#9CA3AF]", children: selectedServices.length ? `${selectedServices.length} service${selectedServices.length > 1 ? "s" : ""} selected` : "Choose one or more services" }),
                          /* @__PURE__ */ jsx(ChevronDown, { className: `h-4 w-4 text-[#FC9C44] transition-transform ${isServiceOpen ? "rotate-180" : ""}` })
                        ]
                      }
                    ),
                  ...
                  errors.services && /* @__PURE__ */ jsx("p", { className: "text-xs text-red-500 font-medium", style: { fontFamily: "'Inter', sans-serif" }, children: errors.services.message })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "grid sm:grid-cols-2 gap-4", children: [
                  /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsx(
                    ...
                    errors.budget && /* @__PURE__ */ jsx("p", { className: "text-xs text-red-500 font-medium", style: { fontFamily: "'Inter', sans-serif" }, children: errors.budget.message })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsx(
                      "label",
                    ...
                    errors.timeline && /* @__PURE__ */ jsx("p", { className: "text-xs text-red-500 font-medium", style: { fontFamily: "'Inter', sans-serif" }, children: errors.timeline.message })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsx(
                  ...
                  errors.message && /* @__PURE__ */ jsx("p", { className: "text-xs text-red-500 font-medium", style: { fontFamily: "'Inter', sans-serif" }, children: errors.message.message })
                ] }),
                /* @__PURE__ */ jsx(
                  "button",
                  {
...
const Route$l = createFileRoute("/case-studies")({
  component: () => /* @__PURE__ */ jsx(Outlet, {})
});
const Route$k = createFileRoute("/blog")({
  component: () => /* @__PURE__ */ jsx(Outlet, {})
});
...
function AdminLeadsPage() {
  ...
  const [activeInbox, setActiveInbox] = useState("contact");
  ...
  const filteredContactInquiries = activeStatusFilter ? inquiries.filter((inquiry) => inquiry.status === activeStatusFilter) : inquiries;
  const filteredGrowthAuditInquiries = activeStatusFilter ? growthAuditInquiries.filter((inquiry) => inquiry.status === activeStatusFilter) : growthAuditInquiries;
  const activeInquiries = activeInbox === "contact" ? filteredContactInquiries : filteredGrowthAuditInquiries;
  ...
  const firstVisibleLead = activeInquiries.length ? (currentLeadPage - 1) * leadsPerPage + 1 : 0;
  ...
  function setActiveLeadPage(page) {
    ...
    return /* @__PURE__ */ jsxs("main", { className: "relative grid min-h-screen place-items-center overflow-hidden bg-[#050B24] px-6 py-12 text-white", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "relative mx-auto w-full max-w-[460px]  -translate-y-25", children: /* @__PURE__ */ jsxs("section", { className: "w-full rounded-lg border border-white/10 bg-white p-7 text-center text-[#101828] shadow-2xl shadow-black/30 sm:p-10", children: [
        ...
        /* @__PURE__ */ jsxs("form", { onSubmit: handleLogin, className: "mt-8 grid gap-5 text-left", children: [
          ...
          error && /* @__PURE__ */ jsx("div", { role: "alert", className: "border border-red-200 bg-red-50 px-4 py-3 text-sm font-semibold text-red-700", children: error }),
          /* @__PURE__ */ jsxs(
            "button",
            {
              type: "submit",
  ...
  return /* @__PURE__ */ jsxs("main", { className: "min-h-screen bg-[#F7F8FA] text-[#101828] lg:flex", children: [
    /* @__PURE__ */ jsx(Toaster, { position: "top-right", richColors: true }),
          ...
          children: [
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-2", children: [
                    /* @__PURE__ */ jsx(Inbox, { className: "h-4 w-4 text-[#FC9C44]" }),
                    "Lead Forms"
                  ] }),
                  /* @__PURE__ */ jsx(
                    ChevronDown,
            ...
            isFormMenuVisible && /* @__PURE__ */ jsxs("div", { className: "absolute left-0 right-0 top-full z-20 mt-2 grid gap-2 border border-[#E4E7EC] bg-white p-2 shadow-xl shadow-[#06133D]/10 lg:static lg:shadow-none", children: [
              /* @__PURE__ */ jsxs(
                Link,
                {
                  to: "/admin",
                  ...
                  className: `flex items-center justify-between rounded-lg border px-3 py-2 text-left text-sm font-bold transition ${activeInbox === "contact" ? "border-[#FC9C44] bg-[#FFF4E8] text-[#C96A13]" : "border-[#E4E7EC] bg-white text-[#344054] hover:border-[#FC9C44]/50"}`,
                  children: [
                    /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxs(
                Link,
                {
                  ...
                  className: `flex items-center justify-between rounded-lg border px-3 py-2 text-left text-sm font-bold transition ${activeInbox === "growthAudit" ? "border-[#FC9C44] bg-[#FFF4E8] text-[#C96A13]" : "border-[#E4E7EC] bg-white text-[#344054] hover:border-[#FC9C44]/50"}`,
                  children: [
                    /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-2", children: [
          ...
          children: [
            /* @__PURE__ */ jsxs(
              Link,
              {
                ...
                className: `flex w-full items-center justify-between rounded-lg px-3 py-3 text-left text-sm font-black transition ${isBlogRoute ? "bg-[#06133D] text-white" : "bg-white text-[#344054] hover:bg-[#F9FAFB] hover:text-[#06133D]"}`,
                children: [
                  /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-2", children: [
                    /* @__PURE__ */ jsx(BookOpenText, { className: `h-4 w-4 ${isBlogRoute ? "text-[#FC9C44]" : "text-[#667085]"}` }),
                    "Posts"
                  ] }),
                  /* @__PURE__ */ jsx(
                    ChevronDown,
                    {
                      className: `h-4 w-4 transition ${isBlogRoute ? "text-white/70" : "text-[#98A2B3]"} ${isPostMenuVisible ? "rotate-180" : ""}`
                    }
                  )
                ]
              }
            ),
            isPostMenuVisible && /* @__PURE__ */ jsx("div", { className: "absolute left-0 right-0 top-full z-20 mt-2 grid gap-2 border border-[#E4E7EC] bg-white p-2 shadow-xl shadow-[#06133D]/10 lg:static lg:shadow-none", children: /* @__PURE__ */ jsxs(
              Link,
              {
                to: "/admin/blog",
                onClick: () => {
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
      /* @__PURE__ */ jsx("div", { className: "border-b border-[#E4E7EC] bg-white", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-between gap-4 px-6 py-5 lg:px-8", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("p", { className: "text-xs font-bold uppercase tracking-[0.11em] text-[#98A2B3]", children: [
            "Viewing ",
            isBlogRoute ? "Blog Posts" : activeInboxTitle
          ] }),
          /* @__PURE__ */ jsx(
            "h2",
            {
              ...
              style: { fontFamily: "'Space Grotesk', sans-serif" },
              children: isBlogRoute ? "All Posts" : `${activeInboxTitle} submissions`
            }
          )
        ] }),
      ...
      isBlogRoute ? /* @__PURE__ */ jsx(Outlet, {}) : /* @__PURE__ */ jsxs("section", { className: "grid gap-6 px-6 py-8 lg:px-8 ", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid gap-3 sm:grid-cols-4 ", children: [
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("p", { className: `text-xs font-bold uppercase tracking-[0.12em] ${activeStatusFilter === null ? "text-white/70" : "text-[#667085]"}`, children: "All Leads" }),
                /* @__PURE__ */ jsx("p", { className: `mt-2 text-3xl font-black ${activeStatusFilter === null ? "text-white" : "text-[#06133D]"}`, children: allActiveInquiries.length })
              ]
            }
          ),
          stats.map(({ status, count }) => /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              className: `border p-4 text-left transition hover:-translate-y-0.5 hover:shadow-md ${activeStatusFilter === status ? "ring-2 ring-[#06133D]/15 shadow-md" : ""} ${status === "NEW" ? "border-[#FED7AA] bg-[#FFF7ED]" : status === "INPROGRESS" ? "border-[#B9D3FF] bg-[#EAF2FF]" : status === "CLOSED" ? "border-[#D0D5DD] bg-[#F2F4F7]" : "border-[#E4E7EC] bg-white"}`,
              children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "overflow-hidden border border-[#E4E7EC] bg-white", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-between gap-2 border-b border-[#E4E7EC] px-5 py-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              activeInbox === "contact" ? /* @__PURE__ */ jsx(Inbox, { className: "h-5 w-5 text-[#FC9C44]" }) : /* @__PURE__ */ jsx(ClipboardList, { className: "h-5 w-5 text-[#FC9C44]" }),
              /* @__PURE__ */ jsxs("h2", { className: "text-base font-black text-[#06133D]", children: [
                activeInboxTitle,
                " submissions"
              ] }),
          ...
          isLoading ? /* @__PURE__ */ jsx("div", { className: "grid min-h-[320px] place-items-center text-sm font-semibold text-[#667085]", children: "Loading leads..." }) : activeInquiries.length === 0 ? /* @__PURE__ */ jsx("div", { className: "grid min-h-[320px] place-items-center px-6 text-center", children: /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "mt-2 max-w-sm text-sm leading-6 text-[#667085]", children: activeStatusFilter ? "Choose another status box to review a different lead group." : inboxCopy[activeInbox].empty })
          ] }) }) : activeInbox === "contact" ? /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "min-w-[1040px] w-full border-collapse text-left", children: [
            ...
            /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-[#E4E7EC]", children: paginatedContactInquiries.map((inquiry) => /* @__PURE__ */ jsxs("tr", { className: "align-top transition hover:bg-[#FFF9F3]", children: [
              /* @__PURE__ */ jsx("td", { className: "px-5 py-4", children: /* @__PURE__ */ jsxs("div", { className: "min-w-[220px]", children: [
                ...
                /* @__PURE__ */ jsxs("p", { className: "mt-2 flex items-center gap-2 text-xs font-semibold text-[#667085]", children: [
                  ...
                  formatDate$1(inquiry.createdAt)
                ] })
              ] }) }),
          ...
          ] }) }) : /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "min-w-[900px] w-full border-collapse text-left", children: [
            /* @__PURE__ */ jsx("thead", { className: "bg-[#F9FAFB] text-xs font-black uppercase tracking-[0.11em] text-[#667085]", children: /* @__PURE__ */ jsxs("tr", { children: [
              /* @__PURE__ */ jsx("th", { className: "px-5 py-3", children: "Lead" }),
            ...
            /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-[#E4E7EC]", children: paginatedGrowthAuditInquiries.map((inquiry) => /* @__PURE__ */ jsxs("tr", { className: "align-top transition hover:bg-[#FFF9F3]", children: [
              /* @__PURE__ */ jsx("td", { className: "px-5 py-4", children: /* @__PURE__ */ jsxs("div", { className: "min-w-[220px]", children: [
                /* @__PURE__ */ jsx("p", { className: "font-black text-[#06133D]", children: inquiry.name }),
                /* @__PURE__ */ jsxs(
                  "a",
              ...
              /* @__PURE__ */ jsx("td", { className: "px-5 py-4", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-2", children: [
                ...
                /* @__PURE__ */ jsx(
                  "select",
                  {
                    value: inquiry.status,
                    disabled: updatingId === inquiry.id,
                    onChange: (event) => void handleGrowthAuditStatusChange(
                      inquiry.id,
                      event.target.value
                    ),
                    className: "rounded-lg border border-[#D0D5DD] bg-white px-3 py-2 text-sm font-bold text-[#344054] outline-none transition focus:border-[#FC9C44] disabled:cursor-not-allowed disabled:opacity-60",
          ...
          activeInquiries.length > 0 && /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-end gap-2 border-t border-[#E4E7EC] px-5 py-4", children: [
            /* @__PURE__ */ jsxs("p", { className: "text-sm font-semibold text-[#667085]", children: [
              firstVisibleLead,
              "-",
              lastVisibleLead,
...
const innerPageBanner = "/assets/inner-page-banner-DUEJw65p.webp";
...
function AboutPage() {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen overflow-hidden bg-white text-[#06133D]", children: [
    /* @__PURE__ */ jsx(Header, {}),
    /* @__PURE__ */ jsxs("main", { children: [
      /* @__PURE__ */ jsxs("section", { className: "relative isolate min-h-[560px] overflow-hidden bg-[#06133D] lg:min-h-[640px]", children: [
        /* @__PURE__ */ jsx(
          "img",
          {
            src: innerPageBanner,
            alt: "Hegxcorp digital growth network",
            className: "absolute inset-0 h-full w-full object-cover object-center opacity-45"
          }
        ),
        /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[linear-gradient(90deg,rgba(6,19,61,0.98)_0%,rgba(6,19,61,0.87)_48%,rgba(6,19,61,0.45)_100%)]" }),
        /* @__PURE__ */ jsx("div", { className: "absolute -left-24 top-24 h-72 w-72 rounded-full bg-[#FC9C44]/20 blur-3xl" }),
        /* @__PURE__ */ jsx("div", { className: "relative mx-auto flex min-h-[560px] max-w-[1280px] items-center px-6 py-20 lg:min-h-[640px] lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl", children: [
          /* @__PURE__ */ jsxs("span", { className: "mb-6 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-xs font-bold uppercase tracking-[0.18em] text-[#FFB36E] backdrop-blur-sm", children: [
            /* @__PURE__ */ jsx(Sparkles, { className: "h-4 w-4" }),
            "About Hegxcorp"
          ] }),
          /* @__PURE__ */ jsx("h1", { className: "text-4xl font-bold leading-[1.08] tracking-[-0.035em] text-white sm:text-5xl lg:text-7xl", children: "One partner for digital growth, built to help you stand out." }),
          /* @__PURE__ */ jsx("p", { className: "mt-7 max-w-2xl text-base leading-8 text-white/75 sm:text-lg", children: "We bring technology, design, and marketing together to help ambitious businesses build stronger brands, reach more people, and create lasting momentum." }),
      ...
      /* @__PURE__ */ jsx("section", { className: "relative py-20 sm:py-24 lg:py-28", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto grid max-w-[1280px] items-center gap-12 px-6 lg:grid-cols-[0.95fr_1.05fr] lg:gap-20 lg:px-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "relative", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "absolute -bottom-6 right-5 rounded-2xl bg-[#06133D] px-6 py-5 text-white shadow-xl sm:right-8", children: [
            /* @__PURE__ */ jsx("p", { className: "text-3xl font-bold text-[#FC9C44]", children: "2016" }),
            /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-white/70", children: "Founded in Mumbai" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "pt-8 lg:pt-0", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-6 text-base leading-8 text-[#52607A] sm:text-lg", children: "Hegxcorp—legally known as AKSHAY JADIA ENTERPRISES—is a technology, digital development, and marketing agency serving businesses across the world." }),
      ...
      /* @__PURE__ */ jsx("section", { className: "border-y border-[#E8ECF5] bg-[#F7F8FB] py-16 sm:py-20", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[1280px] px-6 lg:px-10", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-10 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6", children: appreciationLogos.map((logo) => /* @__PURE__ */ jsx(
          "div",
          {
            className: "flex min-h-24 items-center justify-center rounded-2xl border border-[#E5E9F2] bg-white px-5 py-6",
            children: /* @__PURE__ */ jsx(
              "img",
              {
                src: logo.src,
...
function MagneticButton({ children, strength = 10, className = "" }) {
  ...
  return /* @__PURE__ */ jsx("div", { ref: wrapperRef, className: `inline-flex ${className}`, style: { willChange: "transform" }, children });
}
if (typeof window !== "undefined") {
            ...
            "div",
            {
              ...
              children: projects.map((project, index) => /* @__PURE__ */ jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsx(CaseStudyCursor, { children: /* @__PURE__ */ jsx(
                    ProjectCard,
                    {
                      project,
                      index,
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx("div", { className: "w-full h-44 md:h-52 self-center p-6 overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: `h-full w-full rounded-lg shadow-sm border border-[#EAEAEA] overflow-hidden preview-inner-${index}`, children: /* @__PURE__ */ jsx("div", { className: "scale-110 h-full w-full transition-transform duration-500 ease-out group-hover:scale-[1.14]", children: /* @__PURE__ */ jsx(BrowserPreview$1, { type: project.screenshotType, isActive }) }) }) })
          }
        ),
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-2 gap-16 mt-8 items-start", children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-white/10 bg-white/5 p-6", children: [
                  /* @__PURE__ */ jsx(Quote, { className: "h-5 w-5 text-[#EBB771] mb-3" }),
                  /* @__PURE__ */ jsx(
                    "p",
                    {
                      className: "text-white/85 text-sm leading-relaxed italic mb-4",
                      style: { fontFamily: "'Inter', sans-serif" },
                      children: '"They operate like an extension of our team. The work is sharp, the reporting is honest, and the numbers speak for themselves."'
                    }
                  ),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsx("div", { className: "h-9 w-9 rounded-full bg-[#EBB771] flex items-center justify-center text-[#1D2742] text-xs font-bold font-sans", children: "AK" }),
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx(
                        "div",
                        {
                      ...
                      /* @__PURE__ */ jsx("div", { className: "text-xs text-white/50", children: "Founder, E-Commerce Brand" })
                    ] })
                  ] })
                ] }),
                /* @__PURE__ */ jsx(
                        ...
                        motion.div,
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsx(
                              "span",
                              {
                                className: `text-xs font-bold ${isActive ? "text-[#FC9C44]" : "text-[#6B7280]"}`,
                                style: { fontFamily: "'Space Grotesk', sans-serif" },
                                children: s.num
                              }
                            ),
            ...
            children: [
              ...
              (proofLabel || proofDuration || proofMetric) && /* @__PURE__ */ jsxs("div", { className: "absolute bottom-4 right-4 bg-white/95 backdrop-blur-sm border border-[#EAEAEA] rounded-lg p-3.5 shadow-lg flex items-center gap-4 max-w-[280px] z-10 transition-all duration-[350ms] ease-out group-hover:translate-y-[-3px] group-hover:shadow-2xl", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                  proofMetric && /* @__PURE__ */ jsx("div", { className: "text-sm font-bold text-[#1D2742] tracking-tight truncate leading-tight", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: proofMetric }),
            ...
            /* @__PURE__ */ jsx("div", { className: "rounded-2xl border border-[#EAEAEA] bg-white p-8 lg:p-12 shadow-sm", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-6 text-left", children: [
                ...
                /* @__PURE__ */ jsx(
                  "p",
                  {
                    ...
                    style: { fontFamily: "'Inter', sans-serif" },
                    children: "We're documenting the SEO frameworks, paid media systems, website optimisation strategies, and growth experiments used across client engagements. Launching soon."
                  }
                ),
              ...
              /* @__PURE__ */ jsx("div", { className: "w-full", children: /* @__PURE__ */ jsx(
                BrowserPreview,
                {
                  ...
                  children: /* @__PURE__ */ jsxs("div", { className: "p-8 bg-white h-full flex flex-col justify-center gap-6 select-none", children: [
                    /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
                      /* @__PURE__ */ jsx(Skeleton, { className: "h-4 w-[75%]" }),
                      /* @__PURE__ */ jsx(Skeleton, { className: "h-2.5 w-[45%]" })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
                      /* @__PURE__ */ jsx(Skeleton, { className: "h-4 w-[60%]" }),
                      /* @__PURE__ */ jsx(Skeleton, { className: "h-2.5 w-[35%]" })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
                      /* @__PURE__ */ jsx(Skeleton, { className: "h-4 w-[85%]" }),
                      /* @__PURE__ */ jsx(Skeleton, { className: "h-2.5 w-[50%]" })
                    ] })
                  ] })
                }
              ) })
...
const Route$g = createFileRoute("/case-studies/")({
  head: () => ({
    meta: [
...
function CaseStudiesPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white flex flex-col justify-between", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx(Header, {}),
      /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden bg-white border-b border-[#EAEAEA]", style: { paddingTop: "clamp(80px, 10vw, 140px)", paddingBottom: "clamp(80px, 10vw, 140px)" }, children: [
        /* @__PURE__ */ jsx(
          "div",
          {
            "aria-hidden": "true",
      ...
      /* @__PURE__ */ jsx("section", { className: "bg-[#FC9C44] py-8 border-b border-[#E88C35]", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-[1280px] px-6 lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-y-8 gap-x-0 text-white", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center text-center p-4", children: [
          /* @__PURE__ */ jsx("span", { className: "text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight leading-none", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: "80+" }),
          /* @__PURE__ */ jsx("span", { className: "text-[10px] lg:text-[11px] font-semibold uppercase tracking-wider text-white/90 mt-2", style: { fontFamily: "'Inter', sans-serif" }, children: "Clients Served" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center text-center p-4 border-l border-white/20", children: [
          /* @__PURE__ */ jsx("span", { className: "text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight leading-none", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: "13+" }),
          /* @__PURE__ */ jsx("span", { className: "text-[10px] lg:text-[11px] font-semibold uppercase tracking-wider text-white/90 mt-2", style: { fontFamily: "'Inter', sans-serif" }, children: "Years Experience" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center text-center p-4 border-t border-white/20 md:border-t-0 md:border-l border-white/20", children: [
          /* @__PURE__ */ jsx("span", { className: "text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight leading-none", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: "International" }),
          /* @__PURE__ */ jsx("span", { className: "text-[10px] lg:text-[11px] font-semibold uppercase tracking-wider text-white/90 mt-2", style: { fontFamily: "'Inter', sans-serif" }, children: "Markets Served" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center text-center p-4 border-l border-t border-white/20 md:border-t-0 border-white/20", children: [
          /* @__PURE__ */ jsx("span", { className: "text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight leading-none", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: "SEO • PPC • Web" }),
          /* @__PURE__ */ jsx("span", { className: "text-[10px] lg:text-[11px] font-semibold uppercase tracking-wider text-white/90 mt-2", style: { fontFamily: "'Inter', sans-serif" }, children: "Growth Systems" })
        ] })
      ] }) }) }),
      /* @__PURE__ */ jsx("section", { className: "py-20 md:py-32 bg-[#FAFAF8] relative", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-[1280px] px-6 lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-12 gap-12 lg:gap-20 items-center", children: [
        /* @__PURE__ */ jsxs("div", { className: "lg:col-span-5 space-y-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-6 pt-6 border-t border-[#EAEAEA] text-[#4A5568]", style: { fontFamily: "'Inter', sans-serif" }, children: [
            /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-3 pt-2", children: [
            /* @__PURE__ */ jsxs("div", { className: "bg-white border border-[#EAEAEA] p-3 rounded-lg text-center space-y-0.5 shadow-sm", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "text-sm font-bold text-[#1D2742]", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: "908" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "bg-white border border-[#EAEAEA] p-3 rounded-lg text-center space-y-0.5 shadow-sm", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "text-sm font-bold text-[#1D2742]", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: "150" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "bg-white border border-[#EAEAEA] p-3 rounded-lg text-center space-y-0.5 shadow-sm", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "text-sm font-bold text-[#1D2742]", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: "-48%" }),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-12 bg-white", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[1280px] px-6 lg:px-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "max-w-[700px] mb-20 space-y-4", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-[#6B7280] leading-relaxed text-sm", style: { fontFamily: "'Inter', sans-serif" }, children: "Documented case histories of performance bidding, organic architectures, and local reach integrations built to deliver scalable pipelines." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-24", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
                    /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
                        ...
                        /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold uppercase tracking-wider text-[#FC9C44] mt-0.5", style: { fontFamily: "'Inter', sans-serif" }, children: gpen.metricLabel.toUpperCase() })
                      ] }),
                      /* @__PURE__ */ jsx(
                        "h3",
                        {
                    ...
                    /* @__PURE__ */ jsx("p", { className: "text-sm text-[#4A5568] leading-relaxed", style: { fontFamily: "'Inter', sans-serif" }, children: gpen.summary }),
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
                    /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
                        ...
                        /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold uppercase tracking-wider text-[#FC9C44] mt-0.5", style: { fontFamily: "'Inter', sans-serif" }, children: rollink.metricLabel.toUpperCase() })
                      ] }),
                      /* @__PURE__ */ jsx(
                        "h3",
                        {
                    ...
                    /* @__PURE__ */ jsx("p", { className: "text-sm text-[#4A5568] leading-relaxed", style: { fontFamily: "'Inter', sans-serif" }, children: rollink.summary }),
                    /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2 text-[10px] font-bold text-[#9CA3AF] uppercase tracking-wider border-t border-[#EAEAEA] pt-3", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "h-[1px] w-full bg-[#EAEAEA]" }),
          /* @__PURE__ */ jsx("div", { className: "bg-[#FAFAF8] p-8 md:p-12 rounded-2xl border border-[#EAEAEA]", children: /* @__PURE__ */ jsxs(
            Link,
            {
              to: "/case-studies/$slug",
                ...
                /* @__PURE__ */ jsxs("div", { className: "lg:col-span-5 space-y-6", children: [
                  /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-[#FC9C44] mt-1", style: { fontFamily: "'Inter', sans-serif" }, children: learningTree.metricLabel.toUpperCase() })
                    ] }),
                    /* @__PURE__ */ jsx(
                      "h3",
                      {
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-sm text-[#4A5568] leading-relaxed", style: { fontFamily: "'Inter', sans-serif" }, children: learningTree.summary }),
                  /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2 text-[10px] font-bold text-[#9CA3AF] uppercase tracking-wider border-t border-[#EAEAEA] pt-4", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "bg-white", children: /* @__PURE__ */ jsxs(
            Link,
            {
              ...
              className: "group grid lg:grid-cols-12 gap-12 items-center text-left focus:outline-none",
              children: [
                /* @__PURE__ */ jsxs("div", { className: "lg:col-span-5 space-y-6 order-2 lg:order-1", children: [
                  /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-[#FC9C44] mt-1", style: { fontFamily: "'Inter', sans-serif" }, children: orra.metricLabel.toUpperCase() })
                    ] }),
                    /* @__PURE__ */ jsx(
                      "h3",
                      {
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-sm text-[#4A5568] leading-relaxed", style: { fontFamily: "'Inter', sans-serif" }, children: orra.summary }),
                  /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2 text-[10px] font-bold text-[#9CA3AF] uppercase tracking-wider border-t border-[#EAEAEA] pt-4", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "lg:col-span-7 order-1 lg:order-2", children: /* @__PURE__ */ jsx(
                  BrowserPreview,
                  {
    ...
    /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxs(
        "section",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("div", { "aria-hidden": "true", className: "pointer-events-none absolute inset-0 select-none", style: { opacity: 0.2 }, children: /* @__PURE__ */ jsx(
              ShapeGrid,
              {
                shape: "hexagon",
                squareSize: 38,
            ...
            /* @__PURE__ */ jsx("div", { className: "relative mx-auto max-w-[1280px] px-6 lg:px-10 w-full text-center", children: /* @__PURE__ */ jsxs("div", { className: "max-w-[850px] mx-auto space-y-6", children: [
              /* @__PURE__ */ jsxs(
                "span",
                {
                  className: "inline-flex items-center gap-1.5 rounded-full border border-[#EAEAEA] bg-[#FAFAF8] px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.15em] text-[#FC9C44] shadow-sm",
              ...
              /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("p", { className: "leading-relaxed", children: "Research, frameworks, experiments, and growth systems from real-world execution." }),
                    /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-[#9CA3AF] leading-relaxed", children: "Practical breakdowns of SEO, performance marketing, website architecture, and conversion optimization." })
                  ]
                }
              ),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24 bg-[#FAFAF8] border-b border-[#EAEAEA]", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-[1280px] px-6 lg:px-10", children: /* @__PURE__ */ jsx("div", { className: "rounded-2xl border border-[#EAEAEA] bg-white p-8 lg:p-12 shadow-sm relative overflow-hidden group hover:shadow-[0_20px_50px_rgba(29,39,66,0.05)] transition-all duration-300", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-12 gap-12 lg:gap-16 items-center", children: [
        /* @__PURE__ */ jsxs("div", { className: "lg:col-span-5 space-y-6 text-left", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 text-xs font-semibold text-[#9CA3AF] uppercase tracking-wider", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "lg:col-span-7 w-full", children: /* @__PURE__ */ jsx(Link, { to: "/blog/$slug", params: { slug: featuredArticle.slug }, className: "block", children: /* @__PURE__ */ jsxs(
          motion.div,
          {
            whileHover: "hover",
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 px-4 py-3 bg-white border-b border-[#EAEAEA]", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex-1 max-w-[280px] mx-auto bg-[#FAFAF8] border border-[#EAEAEA] rounded py-0.5 px-3 text-[10px] text-[#9CA3AF] font-mono text-center select-none truncate", children: [
                  "hegxcorp.com/blog/",
                  featuredArticle.slug
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "aspect-video bg-white p-8 flex flex-col justify-between overflow-hidden relative", children: [
                /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-tr from-[#FAFAF8] via-white to-[#FFF4E8]/20 -z-0" }),
                /* @__PURE__ */ jsxs("div", { className: "relative z-10 space-y-6", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold tracking-widest text-[#FC9C44] uppercase bg-[#FFF4E8] px-3 py-1 rounded", children: featuredArticle.category.toUpperCase() }),
                  /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
                    /* @__PURE__ */ jsx("div", { className: "h-6 w-[85%] bg-[#1D2742] rounded-md" }),
                    /* @__PURE__ */ jsx("div", { className: "h-6 w-[50%] bg-[#1D2742] rounded-md" })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "space-y-2 pt-2", children: [
                    /* @__PURE__ */ jsx("div", { className: "h-3 w-full bg-[#EAEAEA] rounded" }),
                    /* @__PURE__ */ jsx("div", { className: "h-3 w-[90%] bg-[#EAEAEA] rounded" }),
                    /* @__PURE__ */ jsx("div", { className: "h-3 w-[65%] bg-[#EAEAEA] rounded" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex justify-between items-end border-t border-[#FAFAF8] pt-4", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsx("span", { className: "h-8 w-8 rounded-full bg-[#FAFAF8] border border-[#EAEAEA] flex items-center justify-center font-bold text-xs text-[#FC9C44]", children: "SS" }),
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("div", { className: "text-[10px] font-bold text-[#1D2742]", children: featuredArticle.author.name }),
                      /* @__PURE__ */ jsx("div", { className: "text-[9px] text-[#9CA3AF]", children: featuredArticle.author.role })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "text-[10px] font-bold text-[#FC9C44] flex items-center gap-1", children: [
                    "Read Article ",
      ...
      /* @__PURE__ */ jsx("section", { id: "main-feed", className: "py-20 bg-white", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-[1280px] px-6 lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-12 gap-12 lg:gap-16", children: [
        /* @__PURE__ */ jsxs("div", { className: "lg:col-span-8 space-y-12", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-[#EAEAEA] pb-5", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-[#1D2742]", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: selectedCategory === "All" && !selectedTag ? "Latest Articles" : selectedCategory !== "All" ? `Category: ${selectedCategory}` : `Topic: #${selectedTag}` }),
          ...
          paginatedArticles.length > 0 ? /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-2 gap-8", children: /* @__PURE__ */ jsx(AnimatePresence, { mode: "popLayout", children: paginatedArticles.map((article) => /* @__PURE__ */ jsx(
              ...
              children: /* @__PURE__ */ jsxs(
                motion.div,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "aspect-video bg-[#FAFAF8] p-6 flex flex-col justify-between border-b border-[#EAEAEA] relative overflow-hidden", children: [
                      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-white via-[#FAFAF8] to-[#FFF4E8]/10" }),
                      /* @__PURE__ */ jsxs("div", { className: "relative z-10 space-y-4", children: [
                        /* @__PURE__ */ jsx("span", { className: "inline-block text-[9px] font-bold text-[#FC9C44] uppercase tracking-wider bg-[#FFF4E8] px-2.5 py-0.5 rounded", children: article.category }),
                        /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
                          /* @__PURE__ */ jsx("div", { className: "h-3 w-[90%] bg-[#1D2742]/75 rounded" }),
                          /* @__PURE__ */ jsx("div", { className: "h-3 w-[60%] bg-[#1D2742]/75 rounded" })
                        ] })
                      ] }),
                      /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex justify-between items-center text-[9px] font-semibold text-[#9CA3AF] uppercase tracking-wider border-t border-[#EAEAEA]/40 pt-3", children: [
                        /* @__PURE__ */ jsx("span", { children: article.readTime }),
                        /* @__PURE__ */ jsx("span", { children: new Date(article.publishedAt).toLocaleDateString("en-US", { month: "long", day: "numeric", year: "numeric" }) })
                      ] })
                    ] }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsx("h4", { className: "text-base font-bold text-[#1D2742]", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: "No insights found" }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-[#6B7280]", style: { fontFamily: "'Inter', sans-serif" }, children: "Try clearing search terms or modifying category selections." })
            ] }),
            /* @__PURE__ */ jsx(
              "button",
              {
        ...
        /* @__PURE__ */ jsx("div", { className: "lg:col-span-4", children: /* @__PURE__ */ jsxs("aside", { className: "space-y-10 lg:sticky lg:top-[120px] lg:h-fit", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-3 text-left", children: [
            /* @__PURE__ */ jsx("h4", { className: "text-xs font-bold text-[#1D2742] uppercase tracking-[0.1em]", style: { fontFamily: "'Inter', sans-serif" }, children: "Search Insights" }),
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsx(
                "input",
                {
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-4 text-left", children: [
            /* @__PURE__ */ jsx("h4", { className: "text-xs font-bold text-[#1D2742] uppercase tracking-[0.1em]", style: { fontFamily: "'Inter', sans-serif" }, children: "Categories" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-4 text-left", children: [
            /* @__PURE__ */ jsx("h4", { className: "text-xs font-bold text-[#1D2742] uppercase tracking-[0.1em]", style: { fontFamily: "'Inter', sans-serif" }, children: "Popular Topics" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-[#EAEAEA] bg-[#FAFAF8] p-6 text-left relative overflow-hidden", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative z-10 space-y-4", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                /* @__PURE__ */ jsx("h4", { className: "text-base font-bold text-[#1D2742]", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: "Get Weekly Growth Insights" }),
                /* @__PURE__ */ jsx("p", { className: "text-xs text-[#6B7280] leading-relaxed", style: { fontFamily: "'Inter', sans-serif" }, children: "Get notified when new guides, frameworks, and digital systems analysis papers go live." })
              ] }),
...
const $$splitComponentImporter$4 = () => import("./service.wordpress-CLENgXmF.js");
const Route$e = createFileRoute("/service/wordpress")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$3 = () => import("./service.web-dev-C32c34IS.js");
const Route$d = createFileRoute("/service/web-dev")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$2 = () => import("./service.web-app--AXtR-uO.js");
const Route$c = createFileRoute("/service/web-app")({
  head: () => ({
    meta: [{
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden bg-[#F7F8FB] px-6 py-24 lg:px-10", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative mx-auto max-w-6xl", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid gap-8 lg:gap-10", children: cards.map((card, index) => {
        ...
        const hasDetails = Boolean(card.detailTitle || card.detailCopy || card.detailPoints?.length);
...
const Route$b = createFileRoute("/service/ui-ux-design")({
  head: () => ({
    meta: [
          ...
          children: /* @__PURE__ */ jsx("div", { className: "rounded-[28px] border border-white/12 bg-white/[0.08] p-5 shadow-[0_34px_90px_-42px_rgba(0,0,0,0.9)] backdrop-blur-xl", children: /* @__PURE__ */ jsxs("div", { className: "rounded-[22px] border border-white/10 bg-[#071333]/92 p-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid gap-4 sm:grid-cols-[0.8fr_1.2fr]", children: [
              /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-white/10 bg-white/[0.06] p-4", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "mt-5 grid gap-3", children: ["Discover", "Compare", "Trust", "Contact"].map((step, index) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 rounded-xl bg-white/[0.06] p-3", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "mt-5 grid gap-4 sm:grid-cols-3", children: ["Wireframes", "Prototype", "Handoff"].map((item) => /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-white/10 bg-white/[0.05] p-4", children: [
...
const Route$a = createFileRoute("/service/social-med")({
  head: () => ({
    meta: [
            ...
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsx("div", { className: "rounded-[28px] border border-white/12 bg-white/[0.08] p-5 shadow-[0_34px_90px_-42px_rgba(0,0,0,0.9)] backdrop-blur-xl", children: /* @__PURE__ */ jsxs("div", { className: "rounded-[22px] border border-white/10 bg-[#071333]/92 p-6", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "grid gap-4 sm:grid-cols-2", children: [
                  ...
                  ["Content Score", "92"],
                  ["Community", "+64%"]
                ].map(([label, value], index) => /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-white/10 bg-white/[0.06] p-4", children: [
                  /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold uppercase tracking-[0.12em] text-white/48", children: label }),
                  /* @__PURE__ */ jsx("p", { className: `mt-3 text-3xl font-black ${index === 1 ? "text-[#FC9C44]" : "text-white"}`, children: value })
                ] }, label)) }),
                /* @__PURE__ */ jsxs("div", { className: "mt-6 rounded-2xl border border-white/10 bg-white/[0.05] p-4", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "grid gap-3", children: [
                    ...
                    /* @__PURE__ */ jsx("div", { className: "h-2 overflow-hidden rounded-full bg-white/10", children: /* @__PURE__ */ jsx("div", { className: "h-full rounded-full bg-gradient-to-r from-[#FC9C44] to-[#FFD4AA]", style: { width } }) })
                  ] }, label)) })
                ] })
              ] }) })
            }
...
const Route$9 = createFileRoute("/service/seo")({
  head: () => ({
    meta: [
...
const seoServiceTracks = [
  ...
  },
  {
    ...
    points: ["Lead-intent keywords", "Decision-stage pages", "Authority content", "Pipeline tracking"]
  },
  {
    icon: ShoppingCart,
    title: "Ecommerce SEO",
...
function SeoServiceDepth() {
  return /* @__PURE__ */ jsx("section", { className: "bg-white px-6 py-24 lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-6xl", children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-14 max-w-6xl", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "mt-6 max-w-6xl text-base leading-8 text-[#5F6B7A]", children: "Hegxcorp covers the practical SEO layers a growing brand needs: local, international, B2B, ecommerce, technical, content, authority, CMS, video, and AI-ready search optimization, helping every important page become easier to discover, understand, trust, and convert.                    " })
    ] }),
  ...
  return /* @__PURE__ */ jsx("section", { className: "border-y border-[#EAEAEA] bg-[#FAFAF8] px-6 py-24 lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-6xl", children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-14 grid gap-8 lg:grid-cols-[0.92fr_1.08fr] lg:items-end lg:gap-14", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "border border-[#E5E7EB] bg-white p-6 shadow-[0_22px_70px_-54px_rgba(6,19,61,0.45)]", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-6 grid gap-3 sm:grid-cols-3", children: ["Technical clarity", "Content direction", "Growth reporting"].map((item) => /* @__PURE__ */ jsx("span", { className: "border border-[#E5E7EB] bg-[#FAFAF8] px-4 py-3 text-sm font-black text-[#06133D]", children: item }, item)) })
      ] })
    ] }),
...
const Route$8 = createFileRoute("/service/ppc")({
  head: () => ({
    meta: [
  ...
  return /* @__PURE__ */ jsx("section", { className: "bg-white px-6 py-24 lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-6xl", children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-14 grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-end lg:gap-14", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "border border-[#E5E7EB] bg-[#FAFAF8] p-6 shadow-[0_22px_70px_-54px_rgba(6,19,61,0.5)]", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-6 grid gap-3 sm:grid-cols-2", children: ["Search intent", "Paid social", "Shopping ads", "Retargeting"].map((item) => /* @__PURE__ */ jsx("span", { className: "border border-[#E5E7EB] bg-white px-4 py-3 text-sm font-black text-[#06133D]", children: item }, item)) })
      ] })
    ] }),
      ...
      return /* @__PURE__ */ jsxs(
        motion.article,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "mt-6 flex flex-wrap gap-2", children: service.points.map((point) => /* @__PURE__ */ jsx("span", { className: "border border-[#E5E7EB] bg-white px-3 py-1.5 text-xs font-bold text-[#536083]", children: point }, point)) })
          ]
        },
        service.title
      );
  ...
  return /* @__PURE__ */ jsx("section", { className: "bg-[#06133D] px-6 py-24 text-white lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-6xl", children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-14 grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-end lg:gap-14", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "w-full max-w-3xl justify-self-end", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-6 grid gap-3 sm:grid-cols-3", children: ["Budget discipline", "Tracking clarity", "Landing page fit"].map((item) => /* @__PURE__ */ jsx("div", { className: "border border-white/12 bg-white/[0.06] px-4 py-3 text-sm font-bold text-white/82", children: item }, item)) })
      ] })
    ] }),
        ...
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsx("div", { className: "rounded-[28px] border border-white/12 bg-white/[0.08] p-5 shadow-[0_34px_90px_-42px_rgba(0,0,0,0.9)] backdrop-blur-xl", children: /* @__PURE__ */ jsxs("div", { className: "rounded-[22px] border border-white/10 bg-[#071333]/92 p-6", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid gap-4 sm:grid-cols-2", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold uppercase tracking-[0.12em] text-white/48", children: label }),
              /* @__PURE__ */ jsx("p", { className: `mt-3 text-3xl font-black ${index === 0 ? "text-[#FC9C44]" : "text-white"}`, children: value })
            ] }, label)) }),
            /* @__PURE__ */ jsxs("div", { className: "mt-6 rounded-2xl border border-white/10 bg-white/[0.05] p-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "mb-4 flex items-center justify-between text-xs font-bold uppercase tracking-[0.12em]", children: [
...
const Route$7 = createFileRoute("/service/graphic-design")({
  head: () => ({
    meta: [
...
const $$splitComponentImporter$1 = () => import("./service.e-comm-Chh-19xn.js");
const Route$6 = createFileRoute("/service/e-comm")({
  head: () => ({
    meta: [{
...
const Route$5 = createFileRoute("/service/content-marketing")({
  head: () => ({
    meta: [
      ...
      return /* @__PURE__ */ jsxs(
        motion.article,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "mt-6 flex flex-wrap gap-2", children: format.points.map((point) => /* @__PURE__ */ jsx("span", { className: "border border-[#E5E7EB] bg-white px-3 py-1.5 text-xs font-bold text-[#536083]", children: point }, point)) })
          ]
        },
        format.title
      );
  ...
  return /* @__PURE__ */ jsx("section", { className: "bg-[#06133D] px-6 py-24 text-white lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-6xl", children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-14 grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-end lg:gap-14", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "w-full border border-white/12 bg-white/[0.06] p-6 shadow-[0_24px_70px_-54px_rgba(0,0,0,0.75)]", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-6 grid gap-3 sm:grid-cols-3", children: ["Search intent", "Buyer questions", "Content reuse"].map((item) => /* @__PURE__ */ jsx("span", { className: "border border-white/12 bg-white/[0.07] px-4 py-3 text-sm font-black text-white/86", children: item }, item)) })
      ] })
    ] }),
          ...
          /* @__PURE__ */ jsx("div", { className: "mt-8 grid gap-3", children: contentStepScrollerSteps.map((step, index) => {
            ...
            return /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("span", { className: `h-2.5 w-2.5 rounded-full ${isActive ? "bg-white" : "bg-white/28"}` }),
            ...
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsx("div", { className: "rounded-[28px] border border-white/12 bg-white/[0.08] p-5 shadow-[0_34px_90px_-42px_rgba(0,0,0,0.9)] backdrop-blur-xl", children: /* @__PURE__ */ jsxs("div", { className: "rounded-[22px] border border-white/10 bg-[#071333]/92 p-6", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "grid gap-4 sm:grid-cols-2", children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold uppercase tracking-[0.12em] text-white/48", children: label }),
                  /* @__PURE__ */ jsx("p", { className: `mt-3 text-3xl font-black ${index === 2 ? "text-[#FC9C44]" : "text-white"}`, children: value })
                ] }, label)) }),
                /* @__PURE__ */ jsxs("div", { className: "mt-6 rounded-2xl border border-white/10 bg-white/[0.05] p-4", children: [
                  /* @__PURE__ */ jsxs("div", { className: "mb-4 flex items-center justify-between text-xs font-bold uppercase tracking-[0.12em]", children: [
                  ...
                  ].map(([label, status]) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between rounded-xl border border-white/10 bg-white/[0.04] px-4 py-3", children: [
...
const $$splitComponentImporter = () => import("./service.branding-Bnlz2pxW.js");
const Route$4 = createFileRoute("/service/branding")({
  head: () => ({
    meta: [{
...
const Route$3 = createFileRoute("/case-studies/$slug")({
  loader: ({ params }) => {
...
function CaseStudyDetailPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white flex flex-col justify-between", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx(Header, {}),
      /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden bg-[#FAFAF8] border-b border-[#EAEAEA]", style: { paddingTop: "clamp(64px, 8vw, 100px)", paddingBottom: "clamp(64px, 8vw, 100px)" }, children: [
        /* @__PURE__ */ jsx(
          "div",
          {
            "aria-hidden": "true",
      ...
      /* @__PURE__ */ jsx("section", { className: "py-20 bg-white border-b border-[#EAEAEA]", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-[960px] px-6 lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "space-y-16", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsx("span", { className: "text-xs font-bold uppercase tracking-wider text-[#FC9C44]", style: { fontFamily: "'Inter', sans-serif" }, children: "01 / The Challenge" }),
          /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold text-[#1D2742]", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: study.challenge.title }),
          /* @__PURE__ */ jsx(
            "div",
            {
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsx("span", { className: "text-xs font-bold uppercase tracking-wider text-[#FC9C44]", style: { fontFamily: "'Inter', sans-serif" }, children: "02 / The Solution" }),
          /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold text-[#1D2742]", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: study.solution.title }),
          /* @__PURE__ */ jsx(
            "div",
            {
              className: "text-[#4A5568] leading-relaxed space-y-4",
      ...
      /* @__PURE__ */ jsx("section", { className: "py-20 bg-[#FAFAF8] border-b border-[#EAEAEA]", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[960px] px-6 lg:px-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center max-w-[640px] mx-auto mb-16 space-y-3", children: [
          /* @__PURE__ */ jsx("span", { className: "text-xs font-bold uppercase tracking-wider text-[#FC9C44]", style: { fontFamily: "'Inter', sans-serif" }, children: "Methodology" }),
          /* @__PURE__ */ jsx("h3", { className: "text-3xl font-bold text-[#1D2742]", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: "Our Approach & Roadmap" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: `grid ${gridColsMap[study.approach?.length || 4] || "md:grid-cols-4"} gap-8 relative`, children: [
          /* @__PURE__ */ jsx("div", { className: "hidden md:block absolute top-[26px] left-[10%] right-[10%] h-0.5 bg-[#EAEAEA] -z-0" }),
          study.approach?.map((step, idx) => /* @__PURE__ */ jsxs("div", { className: "relative bg-white p-6 rounded-xl border border-[#EAEAEA] text-center space-y-3 z-10 shadow-sm", children: [
            /* @__PURE__ */ jsx("div", { className: "mx-auto h-12 w-12 rounded-full bg-[#1D2742] text-white flex items-center justify-center font-bold text-lg", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: step.phase }),
            /* @__PURE__ */ jsx("h4", { className: "font-bold text-[#1D2742] text-sm", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: step.title }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-[#6B7280] leading-relaxed", style: { fontFamily: "'Inter', sans-serif" }, children: step.description })
          ] }, idx))
        ] })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "py-20 bg-white border-b border-[#EAEAEA]", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[960px] px-6 lg:px-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center max-w-[640px] mx-auto mb-16 space-y-3", children: [
          /* @__PURE__ */ jsx("span", { className: "text-xs font-bold uppercase tracking-wider text-[#FC9C44]", style: { fontFamily: "'Inter', sans-serif" }, children: "03 / Verified Results" }),
          /* @__PURE__ */ jsx("h3", { className: "text-3xl font-bold text-[#1D2742]", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: "Documented Client Outcomes" }),
        ...
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-8", children: study.results.metrics.map((metric, idx) => /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-[11px] font-bold text-[#1D2742] uppercase tracking-wider", style: { fontFamily: "'Inter', sans-serif" }, children: metric.label })
            ]
          },
          idx
        )) }),
      ...
      study.testimonial && /* @__PURE__ */ jsx("section", { className: "py-20 bg-[#1D2742] text-white", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[800px] px-6 lg:px-10 text-center space-y-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsx("p", { className: "font-bold text-[#FC9C44]", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: study.testimonial.author }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-[#9CA3AF] font-medium uppercase tracking-wider", style: { fontFamily: "'Inter', sans-serif" }, children: study.testimonial.role })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "py-20 bg-[#FAFAF8] border-b border-[#EAEAEA]", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[960px] px-6 lg:px-10 space-y-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center max-w-[640px] mx-auto mb-10 space-y-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-xs font-bold uppercase tracking-wider text-[#FC9C44]", style: { fontFamily: "'Inter', sans-serif" }, children: "Visual Proof" }),
          /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold text-[#1D2742]", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: "Live System Preview" }),
          /* @__PURE__ */ jsxs("p", { className: "text-xs text-[#6B7280] leading-relaxed", style: { fontFamily: "'Inter', sans-serif" }, children: [
          ...
          Link,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                ...
                /* @__PURE__ */ jsx("h4", { className: "text-sm font-bold text-[#1D2742]", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: item.client }),
                /* @__PURE__ */ jsx("p", { className: "text-xs text-[#6B7280] line-clamp-2 leading-relaxed", style: { fontFamily: "'Inter', sans-serif" }, children: item.summary })
              ] })
            ]
          },
          item.slug
    ...
    switch (block.type) {
      ...
      case "image":
        return /* @__PURE__ */ jsxs("div", { className: "my-8 space-y-2.5 max-w-[760px]", children: [
          /* @__PURE__ */ jsx("img", { src: block.src, alt: block.alt || block.caption, className: "w-full rounded-xl border border-[#EAEAEA] shadow-sm" }),
      ...
      case "table":
        return /* @__PURE__ */ jsx("div", { className: "overflow-x-auto my-6 border border-[#EAEAEA] rounded-xl max-w-[720px]", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left text-xs md:text-sm text-[#4A5568] border-collapse", children: [
          ...
          /* @__PURE__ */ jsx("tbody", { children: block.rows.map((row, rowIndex) => /* @__PURE__ */ jsx("tr", { className: "border-b border-[#EAEAEA]/60 last:border-0 hover:bg-[#FAFAF8]/50 transition-colors", children: row.map((cell, cellIndex) => /* @__PURE__ */ jsx("td", { className: "p-3.5 font-medium", children: cell }, cellIndex)) }, rowIndex)) })
        ] }) }, index);
      default:
        return null;
    }
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white flex flex-col justify-between", children: [
    ...
    /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxs("header", { className: "relative overflow-hidden bg-[#FAFAF8] border-b border-[#EAEAEA] py-14 md:py-20 text-left", children: [
        /* @__PURE__ */ jsx("div", { "aria-hidden": "true", className: "pointer-events-none absolute inset-0 select-none opacity-[0.08]", children: /* @__PURE__ */ jsx(
          ShapeGrid,
          {
            shape: "hexagon",
            squareSize: 40,
      ...
      /* @__PURE__ */ jsx("section", { className: "py-8 bg-white", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-[1280px] px-6 lg:px-10", children: /* @__PURE__ */ jsx("div", { className: "max-w-[850px] mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "relative rounded-xl border border-[#EAEAEA] bg-[#FAFAF8] shadow-[0_24px_48px_rgba(29,39,66,0.06)] overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "aspect-video bg-gradient-to-br from-[#1D2742] to-[#2D3A5D] p-8 md:p-12 flex flex-col justify-between overflow-hidden relative", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative z-10 max-w-[620px] space-y-3.5 text-left", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-xl md:text-3.5xl font-bold text-white leading-tight", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: article.title }),
            /* @__PURE__ */ jsx("p", { className: "text-xs md:text-sm text-white/70 font-normal leading-relaxed max-w-[500px]", style: { fontFamily: "'Inter', sans-serif" }, children: article.excerpt })
          ] }),
        ...
        /* @__PURE__ */ jsxs("aside", { className: "lg:col-span-4 lg:sticky lg:top-28 space-y-8 text-left", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "border border-[#EAEAEA] rounded-xl p-5 bg-[#FAFAF8] space-y-4 relative overflow-hidden", children: [
            /* @__PURE__ */ jsxs("div", { className: "space-y-1 relative z-10", children: [
              ...
              /* @__PURE__ */ jsx("h4", { className: "text-sm font-bold text-[#1D2742]", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: "Weekly Industry Reports" }),
            ...
            /* @__PURE__ */ jsxs("form", { onSubmit: handleSidebarNewsletterSubmit, className: "space-y-2 relative z-10", children: [
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "email",
          ...
          /* @__PURE__ */ jsxs("div", { className: "border border-[#EAEAEA] rounded-xl p-5 bg-[#1D2742] text-white space-y-4 relative overflow-hidden", children: [
            /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(252,156,68,0.1),transparent_50%)] animate-pulse", style: { animationDuration: "6s" } }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 relative z-10", children: [
              /* @__PURE__ */ jsx("h4", { className: "text-sm font-bold leading-tight", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: "Need help growing your business?" }),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-12 border-t border-[#EAEAEA] bg-[#FAFAF8]", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-[1280px] px-6 lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-[850px] mx-auto space-y-14", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-white border border-[#EAEAEA] rounded-2xl p-6 md:p-8 flex flex-col md:flex-row gap-6 items-start text-left shadow-sm", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h4", { className: "text-base font-bold text-[#1D2742]", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: article.author.name }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-[#9CA3AF] font-semibold", children: article.author.role })
            ] }),
            article.author.bio && /* @__PURE__ */ jsx("p", { className: "text-xs md:text-sm text-[#6B7280] leading-relaxed", style: { fontFamily: "'Inter', sans-serif" }, children: article.author.bio })
          ] })
        ] }),
        relatedCaseStudies.length > 0 && /* @__PURE__ */ jsxs("div", { className: "space-y-6 text-left", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-[#1D2742]", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: "Visual Proof: Related Case Studies" }),
            ...
            Link,
            {
              ...
              children: /* @__PURE__ */ jsxs("div", { className: "bg-white border border-[#EAEAEA] rounded-xl p-6 flex flex-col justify-between h-full hover:shadow-[0_12px_24px_rgba(29,39,66,0.04)] hover:-translate-y-0.5 transition-all duration-300", children: [
                /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("h4", { className: "text-base font-bold text-[#1D2742] leading-snug group-hover:text-[#FC9C44] transition-colors mb-1.5", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: cs.client }),
        ...
        relatedArticles.length > 0 && /* @__PURE__ */ jsxs("div", { className: "space-y-6 text-left", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-[#1D2742]", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: "Related Articles" }),
            /* @__PURE__ */ jsx(
              Link,
              {
                to: "/blog",
          ...
          /* @__PURE__ */ jsx("div", { className: "grid md:grid-cols-3 gap-6", children: relatedArticles.map((rel) => /* @__PURE__ */ jsx(
            Link,
            {
              ...
              children: /* @__PURE__ */ jsxs("div", { className: "bg-white border border-[#EAEAEA] rounded-xl p-5 flex flex-col h-full hover:shadow-[0_12px_24px_rgba(29,39,66,0.04)] hover:-translate-y-0.5 transition-all duration-300", children: [
                ...
                /* @__PURE__ */ jsx("h4", { className: "text-sm font-bold text-[#1D2742] group-hover:text-[#FC9C44] transition-colors line-clamp-2 leading-snug mb-3 flex-1", style: { fontFamily: "'Space Grotesk', sans-serif" }, children: rel.title }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "rounded-2xl bg-[#1D2742] text-white p-8 md:p-12 relative overflow-hidden text-center shadow-lg border border-white/5", children: [
          /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(252,156,68,0.12),transparent_50%)] animate-pulse", style: { animationDuration: "8s" } }),
...
const Route$1 = createFileRoute("/api/growth-audit")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        let body;
        ...
        const { createGrowthAuditInquiry } = await import("./growth-audit-inquiries.server-rfzrTq7W.js");
...
const TermsOfServiceRoute = Route$t.update({
  id: "/terms-of-service",
...
const PrivacyPolicyRoute = Route$q.update({
  id: "/privacy-policy",
  path: "/privacy-policy",
  getParentRoute: () => Route$u
});
const IndustriesRoute = Route$p.update({
  id: "/industries",
  path: "/industries",
  getParentRoute: () => Route$u
});
const FreeGrowthAuditRoute = Route$o.update({
  id: "/free-growth-audit",
  path: "/free-growth-audit",
  getParentRoute: () => Route$u
});
const CookiePolicyRoute = Route$n.update({
  id: "/cookie-policy",
  path: "/cookie-policy",
  getParentRoute: () => Route$u
});
...
const CaseStudiesRoute = Route$l.update({
  id: "/case-studies",
  path: "/case-studies",
  getParentRoute: () => Route$u
});
const BlogRoute = Route$k.update({
  id: "/blog",
  path: "/blog",
  getParentRoute: () => Route$u
});
...
const CaseStudiesIndexRoute = Route$g.update({
  id: "/",
  path: "/",
...
const ServiceWordpressRoute = Route$e.update({
  id: "/service/wordpress",
  path: "/service/wordpress",
  getParentRoute: () => Route$u
});
const ServiceWebDevRoute = Route$d.update({
  id: "/service/web-dev",
  path: "/service/web-dev",
  getParentRoute: () => Route$u
});
const ServiceWebAppRoute = Route$c.update({
  id: "/service/web-app",
  path: "/service/web-app",
  getParentRoute: () => Route$u
});
const ServiceUiUxDesignRoute = Route$b.update({
  id: "/service/ui-ux-design",
  path: "/service/ui-ux-design",
  getParentRoute: () => Route$u
});
const ServiceSocialMedRoute = Route$a.update({
  id: "/service/social-med",
  path: "/service/social-med",
  getParentRoute: () => Route$u
});
const ServiceSeoRoute = Route$9.update({
  id: "/service/seo",
  path: "/service/seo",
  getParentRoute: () => Route$u
});
const ServicePpcRoute = Route$8.update({
  id: "/service/ppc",
  path: "/service/ppc",
  getParentRoute: () => Route$u
});
const ServiceGraphicDesignRoute = Route$7.update({
  id: "/service/graphic-design",
  path: "/service/graphic-design",
  getParentRoute: () => Route$u
});
const ServiceECommRoute = Route$6.update({
  id: "/service/e-comm",
  path: "/service/e-comm",
  getParentRoute: () => Route$u
});
const ServiceContentMarketingRoute = Route$5.update({
  id: "/service/content-marketing",
  path: "/service/content-marketing",
  getParentRoute: () => Route$u
});
const ServiceBrandingRoute = Route$4.update({
  id: "/service/branding",
  path: "/service/branding",
  getParentRoute: () => Route$u
});
const CaseStudiesSlugRoute = Route$3.update({
  id: "/$slug",
  path: "/$slug",
  getParentRoute: () => CaseStudiesRoute
});
...
const ApiGrowthAuditRoute = Route$1.update({
  id: "/api/growth-audit",
