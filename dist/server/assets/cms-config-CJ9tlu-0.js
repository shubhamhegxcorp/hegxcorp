const DEFAULT_CMS_SECTIONS = {
  ...
  "home.hero": {
    ...
    description: "We design and execute data-driven growth marketing systems, custom engineering, and search optimization built to position enterprise firms for compounding scale.",
    ...
    items: [
      {
        ...
        description: "Before touching a channel, we audit your full funnel — gaps, leaks and hidden wins. You get a strategy grounded in your actual business, not a recycled template."
      },
      {
        title: "Channels That Compound",
        description: "SEO builds authority that makes paid ads cheaper. Paid ads fund the data that sharpens SEO. We wire the channels together so every pound spent does double the work."
      },
      {
        title: "Outcomes, Not Vanity Metrics",
        description: "Traffic reports don't pay salaries. We tie every KPI back to pipeline and revenue so you always know which activity is making you money."
      },
      {
        title: "Senior Talent, Always On",
        description: "Your account is run by senior strategists — never handed to a junior coordinator after onboarding. The people who pitch the plan are the people who execute it."
      },
      {
        title: "Built to Scale With You",
        description: "As your business grows, the system scales with it. New channels, new markets and new products plug into an existing growth engine instead of starting from scratch."
      }
    ]
  },
  "home.testimonials": {
    ...
    description: "See how we help businesses double their pipeline, optimize paid channels, and compound search authority.",
    testimonials: [
      {
        name: "Priya Sharma",
        ...
        industry: "E-Commerce",
        review: "Hegxcorp's SEO strategy drove a 280% increase in organic revenue within 10 months. What impressed us most was the transparency — we always knew exactly what was being done and why.",
        rating: 5,
        resultValue: "+280%",
      ...
      },
      {
        ...
        company: "LaunchScale",
        industry: "SaaS",
        review: "We were burning through ad spend with another agency and getting nowhere. Hegxcorp restructured our entire paid strategy in 30 days. Our ROAS went from 1.8x to 5.2x. I wish we'd found them sooner.",
        rating: 5,
        resultValue: "5.2x",
      ...
      },
      {
        ...
        industry: "Healthcare",
        review: "The level of strategic thinking Hegxcorp brings is what sets them apart. They don't just execute — they think deeply about the business problem first. Our lead volume doubled in the first quarter.",
        rating: 5,
        resultValue: "2x",
  ...
  "home.faq": {
    ...
    description: "Get answers to common queries about our growth methodologies, platform capabilities, and process.",
    items: [
      {
        question: "How do you measure success in your growth campaigns?",
        answer: "We focus entirely on outcomes rather than vanity metrics. We track business pipeline, qualified leads, and ROAS. Success is defined by revenue generated, not impressions or clicks."
      },
      {
        question: "Do you offer custom service packages?",
        answer: "Yes, we construct custom growth roadmaps tailored to your specific market challenges, user journeys, and pipeline goals."
      },
      {
        question: "Who will manage our account on a day-to-day basis?",
        answer: "Your partnership is managed by senior strategists from start to finish. We do not pass our work off to junior coordinators."
      }
    ]
  },
  "home.cta": {
    ...
    description: "Book a free strategy session and receive a practical growth roadmap tailored to your business. We'll review your website, acquisition channels, and conversion opportunities and show you the highest-impact next steps.",
  ...
  "about.hero": {
    ...
    description: "We bring technology, design, and marketing together to help ambitious businesses build stronger brands, reach more people, and create lasting momentum.",
  ...
  "about.whoWeAre": {
    ...
    description: "Hegxcorp was founded to bridge the gap between creative design, deep technical development, and digital marketing. We operate as an extension of your internal team, focused on compounding returns and business metrics."
  },
  "about.ourMission": {
    tagline: "Our Mission",
    title: "Creating progress, not vanity metrics.",
    description: "We believe digital campaigns should do more than generate reports. Our mission is to engineer high-performance systems and content clusters that establish clear topical authority and drive sustainable revenue expansion."
  },
  "about.ourValues": {
    tagline: "Values",
    title: "Standards we live and build by.",
    description: "These principles guide every strategy we draft, line of code we write, and client relationship we construct.",
    values: [
      {
  ...
  "services.hero": {
    ...
    description: "From websites and web applications to ecommerce, WordPress, SEO, marketing, and maintenance, Hegxcorp helps businesses build a stronger digital presence."
  },
  "services.benefits": {
    tagline: "Why Us",
    title: "Engineered for durability & outcomes",
    description: "Every service we deliver is unified by high standards of performance and clear focus on compounding business scale.",
    benefits: [
  ...
  "services.process": {
    ...
    description: "A disciplined, multi-phase method that ensures transparency, speed, and high-quality results from start to finish.",
    steps: [
      {
  ...
  "products.hero": {
    ...
    description: "Explore our collection of custom-engineered business tools, scalable SaaS solutions, and marketing automation products built to accelerate operations."
  },
  "products.list": {
    products: [
      {
        title: "Hegxcorp LeadCRM",
        description: "A custom lead tracking and marketing automation platform built for enterprise firms to capture, score, and nurture inbound opportunities.",
      ...
      },
      {
        ...
        description: "An AI-powered keyword mapping and content cluster planner that helps content marketing teams design search structures that rank.",
  ...
  "contact.hero": {
    ...
    description: "Get in touch with Hegxcorp's digital transformation consultants. Let's discuss your growth targets, SEO opportunities, and ad performance audit."
  },
  "contact.details": {
    phone: "+91 98765 43210",
    email: "growth@hegxcorp.com",
