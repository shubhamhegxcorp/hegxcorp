...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-B_D6rWJ-.js");
...
const manifest = {
  "0a749c920f3ff82cb75ca65d248a3d0005331af64fb4b47bd0b4248ba2986b34": {
    ...
    importer: () => import("./growth-audit-inquiries-BtU19Bdv.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CVTG3WII.js").then((n) => n.r),
    import("./start-BjZ3WjFT.js"),
