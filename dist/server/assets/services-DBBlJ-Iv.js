...
import { Code2, LayoutDashboard, Globe2, ShoppingCart, Search, BarChart3, Share2, PenTool, Megaphone, Palette, Brush, Image, ArrowRight, Wrench, CheckCircle2, Plus, Smartphone, ShieldCheck, Gauge } from "lucide-react";
import { H as Header, S as ShapeGrid, F as Footer } from "./router-BIL5xJPx.js";
import { motion, AnimatePresence } from "framer-motion";
import "@tanstack/react-query";
import "./contact-inquiries-DNAJih0v.js";
...
const process = [{
  ...
  points: ["Understand your business, users, and goals", "Review competitors and your current digital presence", "Define what success looks like for the project"]
}, {
  title: "Plan digital structure",
  points: ["Map site architecture and user flows", "Choose the right tech stack for your needs", "Set a clear timeline and project milestones"]
}, {
  title: "Design user experience",
  points: ["Wireframe key pages and user journeys", "Design a visual identity and UI components", "Refine the design based on your feedback"]
}, {
  title: "Build and integrate",
  points: ["Develop the frontend and backend systems", "Integrate APIs, payments, and third-party tools", "Set up CMS and content workflows"]
}, {
  title: "Test, launch, improve",
  points: ["Test across devices, browsers, and edge cases", "Launch with monitoring and support in place", "Track performance and iterate after launch"]
}];
const processHighlights = ["Direct communication at every stage", "Fixed milestones, no surprise scope changes", "Feedback built into each step of the build"];
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#F7F8FB] text-[#06133D]", children: [
    ...
    /* @__PURE__ */ jsxs("main", { children: [
      /* @__PURE__ */ jsxs("section", { className: "relative isolate min-h-[560px] overflow-hidden bg-white lg:min-h-[640px]", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "relative mx-auto flex min-h-[560px] max-w-[1280px] items-center px-6 py-20 lg:min-h-[760px] lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl", children: [
          /* @__PURE__ */ jsxs("p", { className: "mb-6 inline-flex items-center gap-2 rounded-full border border-[#EAEAEA] bg-[#FAFAF8] px-4 py-2 text-xs font-bold uppercase tracking-[0.18em] text-[#FC9C44] shadow-sm", children: [
            /* @__PURE__ */ jsx(Wrench, { className: "h-4 w-4" }),
            "Our Services"
          ] }),
          /* @__PURE__ */ jsx("h1", { className: "max-w-5xl text-4xl font-bold leading-[1.08] tracking-[-0.035em] text-[#06133D] sm:text-5xl lg:text-7xl", children: "Digital services built for business growth" }),
          /* @__PURE__ */ jsx("p", { className: "mt-7 max-w-3xl text-base leading-8 text-[#52607A] sm:text-lg", children: "From websites and web applications to ecommerce, WordPress, SEO, marketing, and maintenance, Hegxcorp helps businesses build a stronger digital presence." }),
          /* @__PURE__ */ jsx("div", { className: "mt-10 grid gap-4 border-y border-slate-200 py-6 sm:grid-cols-2 lg:grid-cols-5", children: [["Websites", "Development"], ["Apps", "Dashboards"], ["Stores", "E-Commerce"], ["Growth", "SEO & Marketing"], ["Automation", "Ai Agents & Solutions"]].map(([top, bottom]) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ jsx("span", { className: "h-3 w-3 rounded-full bg-[#FC9C44]" }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-lg font-black text-[#06133D]", children: top }),
      ...
      /* @__PURE__ */ jsx("section", { className: "bg-white px-6 py-24 lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid gap-12 lg:grid-cols-[0.8fr_1.2fr]", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "mt-7 max-w-md text-base leading-8 text-[#52607A]", children: "Every stage is a real conversation, not a black box. Tap any step to see what actually happens, so you always know where your project stands." }),
            /* @__PURE__ */ jsx("div", { className: "mt-10 space-y-5", children: processHighlights.map((item) => /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsx(CheckCircle2, { className: "mt-0.5 h-5 w-5 shrink-0 text-[#FC9C44]" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-[#06133D]", children: item })
            ] }, item)) })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "space-y-0", children: process.map((item, index) => {
            const isOpen = openStep === index;
            return /* @__PURE__ */ jsxs("div", { className: "border-t border-slate-200 last:border-b", children: [
              /* @__PURE__ */ jsxs("button", { type: "button", onClick: () => setOpenStep(isOpen ? null : index), "aria-expanded": isOpen, className: "grid w-full grid-cols-[70px_1fr] items-center py-7 text-left", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-6", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: `flex h-9 w-9 shrink-0 items-center justify-center rounded-full border transition-all duration-300 ${isOpen ? "rotate-45 border-[#FC9C44] bg-[#FC9C44] text-white" : "border-slate-200 text-slate-400"}`, children: /* @__PURE__ */ jsx(Plus, { className: "h-4 w-4" }) })
                ] })
              ] }),
              /* @__PURE__ */ jsx("div", { className: `grid overflow-hidden transition-all duration-300 ease-in-out ${isOpen ? "grid-rows-[1fr] pb-7 opacity-100" : "grid-rows-[0fr] opacity-0"}`, children: /* @__PURE__ */ jsx("div", { className: "min-h-0 pl-[70px]", children: /* @__PURE__ */ jsx("ul", { className: "space-y-3", children: item.points.map((point) => /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-3 text-sm leading-6 text-slate-500", children: [
                /* @__PURE__ */ jsx("span", { className: "mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-[#FC9C44]" }),
                point
              ] }, point)) }) }) })
            ] }, item.title);
          }) })
      ...
      /* @__PURE__ */ jsx("section", { className: "bg-white px-6 py-20 lg:px-10", children: /* @__PURE__ */ jsx("div", { className: "mx-auto overflow-hidden bg-[#06133D] text-white lg:max-w-6xl", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-8 p-8 md:p-12 lg:grid-cols-[1fr_0.7fr] lg:items-center", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("h2", { className: "mt-4 max-w-2xl text-4xl font-black leading-tight", children: "Need a digital solution built for real business growth?" }),
          /* @__PURE__ */ jsx("p", { className: "mt-5 max-w-2xl text-base leading-8 text-white/65", children: "Share your goals, website needs, app idea, ecommerce plan, or growth challenge. We will help you choose the right service path and next steps." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "border-l border-white/15 pl-8", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-2xl font-black", children: "Ready to start?" }),
          /* @__PURE__ */ jsx("p", { className: "mt-3 text-sm leading-7 text-white/65", children: "Get strategy, design, development, marketing, launch, and support in one focused team." }),
