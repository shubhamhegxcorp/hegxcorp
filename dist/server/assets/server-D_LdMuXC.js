...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BDIwQbzQ.js");
...
const manifest = {
  "0a749c920f3ff82cb75ca65d248a3d0005331af64fb4b47bd0b4248ba2986b34": {
    ...
    importer: () => import("./growth-audit-inquiries-BsTJnZro.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CIxUsq07.js").then((n) => n.r),
    import("./start-JuMo56DK.js"),
