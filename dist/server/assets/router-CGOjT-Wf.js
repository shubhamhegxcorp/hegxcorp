...
import { l as listPublishedBlogDrafts, g as getBlogDraft, a as listBlogDrafts, d as deleteBlogDraft, s as saveBlogDraft } from "./blog-drafts-D6gaYuCP.js";
import { Globe, Phone, ChevronDown, Code2, Layers, LayoutTemplate, ShoppingCart, Search, MousePointerClick, Share2, PenLine, Palette, Sparkles, Image, ArrowRight, Check, TrendingUp, Menu, X, Mail, MapPin, Linkedin, Twitter, Instagram, Facebook, ShieldCheck, BarChart3, User, Target, ArrowLeft, Send, RefreshCw, LockKeyhole, UserRound, EyeOff, Eye, Inbox, ClipboardList, BookOpenText, PlusCircle, Megaphone, ChevronRight, LogOut, Award, Handshake, BadgeCheck, Lightbulb, Users, Zap, BarChart2, GitMerge, CalendarCheck, PhoneCall, FileText, Percent, BookOpen, Gauge, Layers3, Rocket, CheckCircle2, Settings, Cloud, Cross, GraduationCap, House, Briefcase, PenTool, CalendarDays, Clapperboard, Link2, Globe2, Building2, Youtube, Activity, LineChart, Smartphone, DollarSign, Presentation, Brush, Camera, MessageSquareText, MessageSquare, Clock, Calendar, Bookmark, Info, AlertCircle, CalendarClock, ChevronLeft, Plus, Star, Pencil, Trash2, Bold, Italic, Strikethrough, Heading1, Heading2, List, ListOrdered, Quote, Code, Link as Link$2, Undo2, Redo2 } from "lucide-react";
...
import { i as inquiryStatuses, s as submitContactInquiry, l as listContactInquiries, u as updateContactInquiryStatus } from "./contact-inquiries-JN2Pe8Z0.js";
...
const appCss = "/assets/styles-3EJqYSb7.css";
const gtmId = void 0;
const ga4Id = void 0;
...
const $$splitComponentImporter$e = () => import("./terms-of-service-BbfLBRpH.js");
const Route$E = createFileRoute("/terms-of-service")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$d = () => import("./services-xIqRSHxT.js");
...
const $$splitComponentImporter$c = () => import("./products-CvoEnVxQ.js");
const Route$B = createFileRoute("/products")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Explore custom-engineered software platforms, CRM integrations, and performance marketing automation systems built by Hegxcorp."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./privacy-policy-DXc_bV4X.js");
...
function useWebsiteSection(key, defaultValue) {
  ...
  const [data, setData] = useState(fallbackVal);
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-[1.5fr_1fr_1fr_1fr] gap-x-10 gap-y-10 items-start", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-5", children: [
              ...
              footerData && /* @__PURE__ */ jsxs(
                "div",
                {
                  className: "space-y-2 mt-1 text-[13px] text-white/55",
                  style: { fontFamily: "'Inter', sans-serif" },
                  children: [
                    footerData.phone && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsx(Phone, { className: "h-3.5 w-3.5 text-[#FC9C44] shrink-0" }),
                      /* @__PURE__ */ jsx(
                        "a",
                        {
                    ...
                    footerData.email && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsx(Mail, { className: "h-3.5 w-3.5 text-[#FC9C44] shrink-0" }),
                      /* @__PURE__ */ jsx(
                        "a",
                        {
                    ...
                    footerData.address && /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
                      /* @__PURE__ */ jsx(MapPin, { className: "h-3.5 w-3.5 text-[#FC9C44] shrink-0 mt-0.5" }),
                      /* @__PURE__ */ jsx("span", { children: footerData.address })
                    ] })
                  ]
                }
              ),
...
const $$splitComponentImporter$a = () => import("./cookie-policy-Bo7QNGxt.js");
                      ...
                      /* @__PURE__ */ jsxs("div", { ref: serviceDropdownRef, className: "relative", children: [
                        ...
                        isServiceOpen && /* @__PURE__ */ jsx(
                          "div",
                          {
                            ...
                            children: /* @__PURE__ */ jsx("div", { className: "grid gap-4 pr-2 md:grid-cols-3", children: (serviceGroupsData.groups || []).map((group) => /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  isWebsiteContentMenuVisible && /* @__PURE__ */ jsx("div", { className: "absolute left-0 right-0 top-full z-20 mt-2 grid gap-2 border border-[#E4E7EC] bg-white p-2 shadow-xl shadow-[#06133D]/10 lg:static lg:shadow-none", children: [
                    ...
                    return /* @__PURE__ */ jsxs(
                      Link,
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsx(ChevronRight, { className: "h-3 w-3 shrink-0" }),
                          item.label
                        ]
                      },
                      item.to
    ...
    /* @__PURE__ */ jsxs("main", { children: [
      /* @__PURE__ */ jsxs("section", { className: "relative isolate min-h-[560px] overflow-hidden bg-white lg:min-h-[640px]", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "relative mx-auto flex min-h-[560px] max-w-[1280px] items-center px-6 py-20 lg:min-h-[800px] lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl", children: [
          ...
          /* @__PURE__ */ jsx("h1", { className: "text-4xl font-bold leading-[1.08] tracking-[-0.035em] text-[#06133D] sm:text-5xl lg:text-7xl", children: heroData.title }),
          /* @__PURE__ */ jsx("p", { className: "mt-7 max-w-2xl text-base leading-8 text-[#52607A] sm:text-lg", children: heroData.description }),
      ...
      /* @__PURE__ */ jsx("section", { className: "relative py-20 sm:py-24 lg:py-28", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto grid max-w-[1280px] items-center gap-12 px-6 lg:grid-cols-[0.95fr_1.05fr] lg:gap-20 lg:px-10", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "pt-8 lg:pt-0", children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-bold uppercase tracking-[0.2em] text-[#E87922]", children: whoWeAreData.tagline }),
          /* @__PURE__ */ jsx("h2", { className: "mt-4 text-3xl font-bold leading-tight tracking-[-0.025em] sm:text-4xl lg:text-5xl", children: whoWeAreData.title }),
          /* @__PURE__ */ jsx(
            "div",
            {
      ...
      /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden bg-[#06133D] py-20 text-white sm:py-24 lg:py-28", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative mx-auto grid max-w-[1280px] items-center gap-12 px-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20 lg:px-10", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm font-bold uppercase tracking-[0.2em] text-[#FFB36E]", children: ourMissionData.tagline }),
            /* @__PURE__ */ jsx("h2", { className: "mt-4 text-3xl font-bold leading-tight tracking-[-0.025em] sm:text-4xl lg:text-5xl", children: ourMissionData.title }),
            /* @__PURE__ */ jsx(
              "div",
              {
      ...
      /* @__PURE__ */ jsx("section", { className: "py-20 sm:py-24 lg:py-28", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[1280px] px-6 lg:px-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-3xl text-center", children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-bold uppercase tracking-[0.2em] text-[#E87922]", children: ourValuesData.tagline }),
          /* @__PURE__ */ jsx("h2", { className: "mt-4 text-3xl font-bold leading-tight tracking-[-0.025em] sm:text-4xl lg:text-5xl", children: ourValuesData.title }),
          /* @__PURE__ */ jsx("p", { className: "mt-5 text-base leading-8 text-[#52607A] sm:text-lg", children: ourValuesData.description })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mt-14 grid items-stretch gap-6 lg:grid-cols-[0.9fr_1.1fr]", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "grid gap-6 sm:grid-cols-2", children: (ourValuesData.values || []).map(({ title, description }, index) => {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx(
                  "h1",
                  {
                    ...
                    children: heroData.title.includes("Leads, Sales") ? /* @__PURE__ */ jsxs(Fragment, { children: [
                      "Generate More",
                      " ",
                      /* @__PURE__ */ jsxs("span", { className: "relative", children: [
                        "Leads, Sales",
  ...
  return /* @__PURE__ */ jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[1280px] px-6 lg:px-10 space-y-16", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-5 gap-px bg-[#EAEAEA] border border-[#EAEAEA] rounded-2xl overflow-hidden", children: mappedPillars.map((p, i) => /* @__PURE__ */ jsxs(
          motion.div,
          {
            initial: "hidden",
            whileInView: "show",
  ...
  return /* @__PURE__ */ jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[1280px] px-6 lg:px-10", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "divide-y divide-[#EAEAEA]", children: (sectionData.testimonials || []).map((t, i) => /* @__PURE__ */ jsxs(
          motion.div,
          {
            custom: i,
            initial: "hidden",
            ...
            /* @__PURE__ */ jsx("div", { className: "rounded-2xl border border-[#EAEAEA] bg-white p-8 lg:p-12 shadow-sm", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "w-full", children: /* @__PURE__ */ jsx(
                BrowserPreview,
                {
                  ...
                  children: /* @__PURE__ */ jsx(Link, { to: "/blog/$slug", params: { slug }, children: /* @__PURE__ */ jsx("img", { src: imageSrc, alt: title, className: "w-full h-full object-cover" }) })
                }
              ) })
            ] }) })
          ]
...
function HomeFAQ() {
  ...
  return /* @__PURE__ */ jsx("section", { className: "bg-[#FAFAF8] py-20 sm:py-24 lg:py-28 overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-[1280px] px-6 lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-[1.1fr_1.9fr] gap-12 lg:gap-20", children: [
    /* @__PURE__ */ jsx(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
    ...
    /* @__PURE__ */ jsx("div", { className: "divide-y divide-[#EAEAEA] border-t border-[#EAEAEA] mt-4 lg:mt-0", children: items.map((item, index) => {
...
function BlogPage() {
  ...
  if (!blogsLoaded || !featuredArticle) {
    return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white flex flex-col", children: [
      /* @__PURE__ */ jsx(Header, {}),
      /* @__PURE__ */ jsx("div", { className: "flex flex-1 items-center justify-center py-40 text-sm font-semibold text-[#6B7280]", children: "Loading articles…" }),
      /* @__PURE__ */ jsx(Footer, {})
    ] });
  }
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white flex flex-col justify-between", children: [
...
const $$splitComponentImporter$9 = () => import("./service.wordpress-CeqIRpRn.js");
const Route$o = createFileRoute("/service/wordpress")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$8 = () => import("./service.web-dev-YCxv65Af.js");
const Route$n = createFileRoute("/service/web-dev")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$7 = () => import("./service.web-app-9Ibc4pTe.js");
const Route$m = createFileRoute("/service/web-app")({
  head: () => ({
    meta: [{
...
const Route$l = createFileRoute("/service/ui-ux-design")({
  head: () => ({
    meta: [
...
const Route$k = createFileRoute("/service/social-med")({
  head: () => ({
    meta: [
...
const Route$j = createFileRoute("/service/seo")({
  head: () => ({
    meta: [
...
const Route$i = createFileRoute("/service/ppc")({
  head: () => ({
    meta: [
...
const Route$h = createFileRoute("/service/graphic-design")({
  head: () => ({
    meta: [
...
const $$splitComponentImporter$6 = () => import("./service.e-comm-5Olu1hH-.js");
const Route$g = createFileRoute("/service/e-comm")({
  head: () => ({
    meta: [{
...
const Route$f = createFileRoute("/service/content-marketing")({
  head: () => ({
    meta: [
...
const $$splitComponentImporter$5 = () => import("./service.branding-CbSLGG3f.js");
const Route$e = createFileRoute("/service/branding")({
  head: () => ({
    meta: [{
...
const Route$d = createFileRoute("/case-studies/$slug")({
  loader: ({ params }) => {
...
function BlogDetailPage() {
  const { article } = Route$c.useLoaderData();
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white flex flex-col justify-between", children: [
    ...
    /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "py-8 bg-white", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-[1280px] px-6 lg:px-10", children: /* @__PURE__ */ jsx("div", { className: "max-w-[850px] mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "relative rounded-xl border border-[#EAEAEA] bg-[#FAFAF8] shadow-[0_24px_48px_rgba(29,39,66,0.06)] overflow-hidden", children: [
        ...
        article.featuredImage ? /* @__PURE__ */ jsx(
          "img",
          {
          ...
          /* @__PURE__ */ jsx("div", { className: "relative z-10 max-w-[620px] space-y-3.5 text-left", children: /* @__PURE__ */ jsx(
            "h3",
            {
...
const Route$b = createFileRoute("/api/growth-audit")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        let body;
        ...
        const { createGrowthAuditInquiry } = await import("./growth-audit-inquiries.server-CZxN0BUo.js");
...
const Route$a = createFileRoute("/admin/growth-leads")({
  head: () => ({
    meta: [
...
const Route$9 = createFileRoute("/admin/contact-leads")({
  head: () => ({
    meta: [
...
function BlogPreview({ data, backHref }) {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "sticky top-0 z-[110] flex items-center justify-between border-b border-[#EAEAEA] bg-[#1D2742] px-4 py-2.5 text-white", children: [
          /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#FC9C44]", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white flex flex-col justify-between", children: [
          /* @__PURE__ */ jsx("header", { className: "relative overflow-hidden bg-[#FAFAF8] border-b border-[#EAEAEA] py-14 md:py-20 text-left", children: /* @__PURE__ */ jsx("div", { className: "relative mx-auto max-w-[1280px] px-6 lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-[850px] mx-auto space-y-6", children: [
            /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs(
              "a",
              {
                href: backHref,
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3 text-xs font-bold text-[#FC9C44] uppercase tracking-wider", children: [
              /* @__PURE__ */ jsx("span", { className: "bg-[#FFF4E8] px-2.5 py-1 rounded-md", children: category }),
              /* @__PURE__ */ jsx("span", { children: "•" }),
              /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1", children: [
                /* @__PURE__ */ jsx(Clock, { className: "h-3.5 w-3.5" }),
                " ",
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-6 pt-6 border-t border-[#EAEAEA]", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsx("span", { className: "h-10 w-10 rounded-full bg-[#1D2742] text-white flex items-center justify-center font-bold text-xs select-none", children: authorInitials }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("div", { className: "text-xs font-bold text-[#1D2742]", children: authorName }),
                  /* @__PURE__ */ jsx("div", { className: "text-[10px] text-[#9CA3AF] font-semibold", children: authorRole })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-xs font-semibold text-[#6B7280]", children: [
                /* @__PURE__ */ jsx("span", { className: "text-[10px] uppercase font-bold tracking-wider mr-1.5", children: "Share article:" }),
                /* @__PURE__ */ jsx("span", { className: "p-2 border border-[#EAEAEA] rounded-full", children: /* @__PURE__ */ jsx(Twitter, { className: "h-3.5 w-3.5" }) }),
                /* @__PURE__ */ jsx("span", { className: "p-2 border border-[#EAEAEA] rounded-full", children: /* @__PURE__ */ jsx(Linkedin, { className: "h-3.5 w-3.5" }) }),
                /* @__PURE__ */ jsx("span", { className: "p-2 border border-[#EAEAEA] rounded-full", children: /* @__PURE__ */ jsx(Link2, { className: "h-3.5 w-3.5" }) })
              ] })
            ] })
          ] }) }) }),
          /* @__PURE__ */ jsx("section", { className: "py-8 bg-white", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-[1280px] px-6 lg:px-10", children: /* @__PURE__ */ jsx("div", { className: "max-w-[850px] mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "relative rounded-xl border border-[#EAEAEA] bg-[#FAFAF8] shadow-[0_24px_48px_rgba(29,39,66,0.06)] overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsx("main", { className: "py-10 bg-white", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-[1280px] px-6 lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-12 gap-12 max-w-[850px] mx-auto items-start", children: [
            /* @__PURE__ */ jsx("div", { className: "lg:col-span-8 text-left", children: /* @__PURE__ */ jsx("article", { className: "max-w-none", children: /* @__PURE__ */ jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsxs("aside", { className: "lg:col-span-4 lg:sticky lg:top-28 space-y-8 text-left", children: [
              /* @__PURE__ */ jsxs("div", { className: "border border-[#EAEAEA] rounded-xl p-5 bg-white space-y-3", children: [
                /* @__PURE__ */ jsx("h4", { className: "text-xs font-bold text-[#1D2742] uppercase tracking-wider", children: "Share Article" }),
                /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                  /* @__PURE__ */ jsxs("span", { className: "flex-1 flex justify-center items-center gap-1.5 py-2 border border-[#EAEAEA] rounded-lg text-xs font-semibold text-[#4A5568]", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "border border-[#EAEAEA] rounded-xl p-5 bg-[#FAFAF8] space-y-4", children: [
                /* @__PURE__ */ jsx("div", { className: "flex h-8 w-8 items-center justify-center rounded-lg bg-[#FFF4E8] text-[#FC9C44]", children: /* @__PURE__ */ jsx(Mail, { className: "h-4 w-4" }) }),
                /* @__PURE__ */ jsx(
                  "h4",
                  {
                    className: "text-sm font-bold text-[#1D2742]",
                ...
                /* @__PURE__ */ jsx("p", { className: "text-[11px] text-[#6B7280] leading-relaxed", children: "Deep marketing experiments and growth frameworks sent to your inbox." }),
                /* @__PURE__ */ jsx("div", { className: "w-full rounded-lg bg-[#FC9C44] py-2 text-center text-xs font-semibold text-white", children: "Subscribe" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "border border-[#EAEAEA] rounded-xl p-5 bg-[#1D2742] text-white space-y-4", children: [
                /* @__PURE__ */ jsx(
                  "h4",
                  {
                    className: "text-sm font-bold leading-tight",
                ...
                /* @__PURE__ */ jsx("p", { className: "text-[11px] text-white/70 leading-relaxed", children: "Claim a free manual performance audit of your acquisition loops." }),
                /* @__PURE__ */ jsxs("span", { className: "w-full inline-flex justify-center items-center gap-1.5 rounded-lg bg-[#FC9C44] py-2 text-xs font-bold text-[#1D2742]", children: [
                  "Book Free Growth Audit ",
                  /* @__PURE__ */ jsx(ArrowRight, { className: "h-3 w-3" })
                ] })
              ] })
...
const Route$8 = createFileRoute("/admin/blog-preview")({
...
function BlogPreviewPage() {
  const { draft: draftId } = Route$8.useSearch();
  ...
  if (state === "ready" && draft) {
    return /* @__PURE__ */ jsx(BlogPreview, { data: blogDraftToPreview(draft), backHref });
  }
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-[100] grid place-items-center bg-white px-6 text-center", children: state === "loading" ? /* @__PURE__ */ jsxs("div", { className: "grid place-items-center gap-3 text-sm font-bold text-[#06133D]", children: [
    /* @__PURE__ */ jsx(RefreshCw, { className: "h-7 w-7 animate-spin text-[#FC9C44]" }),
    "Loading preview…"
  ] }) : /* @__PURE__ */ jsxs("div", { className: "grid max-w-md place-items-center gap-3", children: [
    /* @__PURE__ */ jsx("h1", { className: "text-xl font-black text-[#06133D]", children: state === "error" ? "Preview could not load" : "Draft not found" }),
    /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-[#667085]", children: state === "error" ? "Something went wrong while loading this draft. Head back to the editor and try again." : "This draft may have been deleted, or it was never saved. Return to the editor to continue." }),
    /* @__PURE__ */ jsx(
      "a",
      {
        href: backHref,
...
const Route$7 = createFileRoute("/admin/blog")({
  head: () => ({
    meta: [
...
function AdminBlogPostsPage() {
  ...
  useEffect(() => {
    let active = true;
    listBlogDrafts().then((rows2) => {
      if (active) setDrafts(rows2);
    }).catch((loadError) => {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "grid gap-6 px-6 py-8 lg:px-8", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h1", { className: "text-lg font-black text-[#06133D]", children: "Blog posts" }),
        /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-[#667085]", children: "Manage every post, published or in progress." })
      ] }),
      /* @__PURE__ */ jsxs(
        "button",
        {
    ...
    /* @__PURE__ */ jsx("div", { className: "flex flex-wrap items-center gap-3 border border-[#E4E7EC] bg-white px-4 py-4", children: /* @__PURE__ */ jsx("div", { className: "ml-auto flex flex-wrap items-center gap-3", children: /* @__PURE__ */ jsxs("p", { className: "text-sm font-semibold text-[#667085]", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "overflow-hidden border border-[#E4E7EC] bg-white", children: [
      ...
      filteredPosts.length === 0 ? /* @__PURE__ */ jsx("div", { className: "grid min-h-[320px] place-items-center px-6 text-center", children: /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-2 max-w-sm text-sm leading-6 text-[#667085]", children: "Clear the search or category filter to review the full blog library." })
        ...
        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-[#E4E7EC]", children: paginatedPosts.map((post) => {
          const isUpdating = post.draftId != null && updatingId === post.draftId;
          return /* @__PURE__ */ jsxs("tr", { className: "align-top transition hover:bg-[#FFF9F3]", children: [
            ...
            /* @__PURE__ */ jsx("td", { className: "px-5 py-4", children: /* @__PURE__ */ jsx("div", { className: "flex min-w-[150px] flex-wrap items-center gap-2", children: post.draftId ? /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx(
                "a",
                {
        ...
        children: [
          filteredCategories.map((cat) => {
            ...
            return /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxs("label", { className: "flex cursor-pointer items-center gap-2 text-xs font-bold text-[#344054] hover:text-[#06133D]", children: [
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "checkbox",
...
function RichTextEditor({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-[#D0D5DD] focus-within:border-[#FC9C44]", children: [
...
function Toolbar({ editor }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-1 rounded-t-lg border-b border-[#D0D5DD] bg-[#F9FAFB] px-2 py-2", children: [
    /* @__PURE__ */ jsx(
      ToolbarButton,
      {
        label: "Bold",
    ...
    /* @__PURE__ */ jsx(Divider, {}),
    /* @__PURE__ */ jsx(ToolbarButton, { label: "Link", onClick: addLink, active: editor.isActive("link"), children: /* @__PURE__ */ jsx(Link$2, { size: 16 }) }),
    /* @__PURE__ */ jsx(ToolbarButton, { label: "Upload image", onClick: () => imageInputRef.current?.click(), children: /* @__PURE__ */ jsx(Image, { size: 16 }) }),
    /* @__PURE__ */ jsx(
      "input",
      {
        ref: imageInputRef,
...
function Divider() {
  return /* @__PURE__ */ jsx("span", { className: "mx-1 h-5 w-px bg-[#E4E7EC]", "aria-hidden": "true" });
}
function TagInput({
  value,
  onChange,
...
const Route$6 = createFileRoute("/admin/add-blog")({
  head: () => ({
    meta: [
...
function CreateBlogPage() {
  ...
  const [draftId] = useState(() => search.draft ?? generateId());
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid gap-6 lg:grid-cols-[1fr_416px] ", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid gap-6 ", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "flex gap-3", children: /* @__PURE__ */ jsx("div", { className: "flex-1 rounded-lg border border-[#D0D5DD] bg-[#F9FAFB] px-4 py-5 text-sm font-bold text-[#667085]", children: form.slug }) })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "mb-2 block text-xs font-black uppercase tracking-wide text-[#667085]", children: "Focus Key Pharse" }),
          /* @__PURE__ */ jsx(
            "textarea",
            {
              value: form.excerpt,
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "mb-2 block text-xs font-black uppercase tracking-wide text-[#667085]", children: "Seo title" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              value: form.seotitle,
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "mb-2 block text-xs font-black uppercase tracking-wide text-[#667085]", children: "Author Name" }),
          /* @__PURE__ */ jsx(
            "input",
            {
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid gap-6 self-start", children: [
        ...
        /* @__PURE__ */ jsx(
          PostCategoryPicker,
          {
            ...
            onSelect: (categories2) => updateField("category", categories2),
...
const Route$5 = createFileRoute("/admin/ad-leads")({
  head: () => ({
    meta: [
...
const $$splitComponentImporter$4 = () => import("./admin.website-content.services-CVq22ysJ.js");
const Route$4 = createFileRoute("/admin/website-content/services")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./admin.website-content.products-jWpR6u54.js");
const Route$3 = createFileRoute("/admin/website-content/products")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./admin.website-content.home-BO20kvh9.js");
const Route$2 = createFileRoute("/admin/website-content/home")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./admin.website-content.contact-Ow1RV2Qq.js");
const Route$1 = createFileRoute("/admin/website-content/contact")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./admin.website-content.about-B6Awxtc1.js");
const Route = createFileRoute("/admin/website-content/about")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const TermsOfServiceRoute = Route$E.update({
  id: "/terms-of-service",
...
const ServiceWordpressRoute = Route$o.update({
  id: "/service/wordpress",
  path: "/service/wordpress",
  getParentRoute: () => Route$F
});
const ServiceWebDevRoute = Route$n.update({
  id: "/service/web-dev",
  path: "/service/web-dev",
  getParentRoute: () => Route$F
});
const ServiceWebAppRoute = Route$m.update({
  id: "/service/web-app",
  path: "/service/web-app",
  getParentRoute: () => Route$F
});
const ServiceUiUxDesignRoute = Route$l.update({
  id: "/service/ui-ux-design",
  path: "/service/ui-ux-design",
  getParentRoute: () => Route$F
});
const ServiceSocialMedRoute = Route$k.update({
  id: "/service/social-med",
  path: "/service/social-med",
  getParentRoute: () => Route$F
});
const ServiceSeoRoute = Route$j.update({
  id: "/service/seo",
  path: "/service/seo",
  getParentRoute: () => Route$F
});
const ServicePpcRoute = Route$i.update({
  id: "/service/ppc",
  path: "/service/ppc",
  getParentRoute: () => Route$F
});
const ServiceGraphicDesignRoute = Route$h.update({
  id: "/service/graphic-design",
  path: "/service/graphic-design",
  getParentRoute: () => Route$F
});
const ServiceECommRoute = Route$g.update({
  id: "/service/e-comm",
  path: "/service/e-comm",
  getParentRoute: () => Route$F
});
const ServiceContentMarketingRoute = Route$f.update({
  id: "/service/content-marketing",
  path: "/service/content-marketing",
  getParentRoute: () => Route$F
});
const ServiceBrandingRoute = Route$e.update({
  id: "/service/branding",
  path: "/service/branding",
  getParentRoute: () => Route$F
});
const CaseStudiesSlugRoute = Route$d.update({
  id: "/$slug",
  path: "/$slug",
  getParentRoute: () => CaseStudiesRoute
});
...
const ApiGrowthAuditRoute = Route$b.update({
  id: "/api/growth-audit",
  path: "/api/growth-audit",
  getParentRoute: () => Route$F
});
const AdminGrowthLeadsRoute = Route$a.update({
  id: "/growth-leads",
  path: "/growth-leads",
  getParentRoute: () => AdminRoute
});
const AdminContactLeadsRoute = Route$9.update({
  id: "/contact-leads",
  path: "/contact-leads",
  getParentRoute: () => AdminRoute
});
const AdminBlogPreviewRoute = Route$8.update({
  id: "/blog-preview",
  path: "/blog-preview",
  getParentRoute: () => AdminRoute
});
const AdminBlogRoute = Route$7.update({
  id: "/blog",
  path: "/blog",
  getParentRoute: () => AdminRoute
});
const AdminAddBlogRoute = Route$6.update({
  id: "/add-blog",
  path: "/add-blog",
  getParentRoute: () => AdminRoute
});
const AdminAdLeadsRoute = Route$5.update({
  id: "/ad-leads",
  path: "/ad-leads",
  getParentRoute: () => AdminRoute
});
const AdminWebsiteContentServicesRoute = Route$4.update({
  id: "/website-content/services",
  path: "/website-content/services",
  getParentRoute: () => AdminRoute
});
const AdminWebsiteContentProductsRoute = Route$3.update({
...
const AdminRouteChildren = {
  ...
  AdminWebsiteContentProductsRoute,
...
export {
  ...
  Header as H,
  ShapeGrid as S,
  getWebsiteSection as g,
  router as r,
  saveWebsiteSection as s,
