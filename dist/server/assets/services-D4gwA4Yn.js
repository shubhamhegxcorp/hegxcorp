...
import { H as Header, S as ShapeGrid, F as Footer } from "./router-CIxUsq07.js";
    ...
    /* @__PURE__ */ jsxs("main", { children: [
      /* @__PURE__ */ jsxs("section", { className: "relative isolate min-h-[560px] overflow-hidden bg-white lg:min-h-[640px]", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "relative mx-auto flex min-h-[560px] max-w-[1280px] items-center px-6 py-20 lg:min-h-[760px] lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "mt-10 grid gap-4 border-y border-slate-200 py-6 sm:grid-cols-2 lg:grid-cols-4", children: [["Websites", "Development"], ["Apps", "Dashboards"], ["Stores", "E-Commerce"], ["Growth", "SEO & Marketing"]].map(([top, bottom]) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
