...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BUvFsTDC.js");
...
const manifest = {
  "0a749c920f3ff82cb75ca65d248a3d0005331af64fb4b47bd0b4248ba2986b34": {
    ...
    importer: () => import("./growth-audit-inquiries-D9TOf_66.js")
  },
  ...
  "83f6aed03b3ca362ab36ece6f2445ae8c877362afd4e531cd65e59875a74e12f": {
    ...
    importer: () => import("./visitor-events-CB2BZ-fr.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BIL5xJPx.js").then((n) => n.r),
    import("./start-meSYvLm8.js"),
