...
function OurServicesPage() {
  const {
    data: heroData
  } = useWebsiteSection("services.hero");
  const {
    data: benefitsData
  } = useWebsiteSection("services.benefits");
  const {
    data: processData
  } = useWebsiteSection("services.process");
    ...
    /* @__PURE__ */ jsxs("main", { children: [
      /* @__PURE__ */ jsxs("section", { className: "relative isolate min-h-[560px] overflow-hidden bg-white lg:min-h-[640px]", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "relative mx-auto flex min-h-[560px] max-w-[1280px] items-center px-6 py-20 lg:min-h-[760px] lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-7 max-w-3xl text-base leading-8 text-[#52607A] sm:text-lg", children: heroData.description }),
      ...
      /* @__PURE__ */ jsx("section", { className: "bg-[#06133D] px-6 py-24 text-white lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto grid max-w-7xl gap-14 lg:grid-cols-[1fr_1.1fr] lg:items-center", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm font-bold uppercase tracking-[0.22em] text-[#FC9C44]", children: benefitsData.tagline }),
          /* @__PURE__ */ jsx("h2", { className: "mt-4 text-4xl font-black leading-tight md:text-6xl", children: benefitsData.title }),
          /* @__PURE__ */ jsx("p", { className: "mt-7 max-w-xl text-base leading-8 text-white/70", children: benefitsData.description }),
        ...
        /* @__PURE__ */ jsx("div", { className: "grid gap-px overflow-hidden rounded-[32px] bg-white/15 sm:grid-cols-2", children: (benefitsData.benefits || []).map((benefit) => /* @__PURE__ */ jsxs("div", { className: "bg-[#06133D] p-6", children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "bg-white px-6 py-24 lg:px-10", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid gap-12 lg:grid-cols-[0.8fr_1.2fr]", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm font-bold uppercase tracking-[0.22em] text-[#FC9C44]", children: processData.tagline }),
            /* @__PURE__ */ jsx("h2", { className: "mt-4 text-4xl font-black leading-tight md:text-5xl", children: processData.title }),
            /* @__PURE__ */ jsx("p", { className: "mt-7 max-w-md text-base leading-8 text-[#52607A]", children: processData.description }),
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-0", children: (processData.steps || []).map((item, index) => {
